...
Latest imported channel run: `2026-07-13T07:41:56.978Z` · latest `2026.7.2` / `700c87f0f2`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,688ms` | `2,082ms` | `1,075MB` | `1,089MB` | ok |
| Slack | `3,337ms` | `3,337ms` | `800MB` | `800MB` | ok |
...
Latest imported surface run: `2026-07-13T01:01:39.566Z` · latest `2026.7.2` / `5c49055293`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `4ms` | `11ms` | `174MB` | `185MB` | ok: gateway RPC |
| Control UI | `289ms` | `319ms` | `492MB` | `1,130MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-13T08:32:10.260Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.7.1-beta.6` | `1,418ms` | - | - | `3,335ms` | - | `3,335ms` | `328ms` |
...
Latest imported surface run: `2026-07-13T07:43:32.613Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `1,070MB` | `1,073MB` | timeout |
| `2026.5.16-beta.5` | - | - | `1,071MB` | `1,074MB` | timeout |
...
| `2026.6.8-beta.1` | - | - | `608MB` | `608MB` | failed |
| `2026.6.7-beta.1` | - | - | `618MB` | `618MB` | failed |
| `2026.6.6` | - | - | `616MB` | `616MB` | failed: QA command exited with status 0 before writing a summary. |
