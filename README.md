...
Latest imported channel run: `2026-09-09T13:15:06.733Z` · latest `2026.9.3` / `7839c0b966`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `999ms` | `2,007ms` | `87MB` | `87MB` | ok |
| Discord | `2,455ms` | `2,609ms` | `680MB` | `758MB` | ok |
| Slack | `3,002ms` | `3,236ms` | `675MB` | `687MB` | ok |
...
Latest imported surface run: `2026-09-09T12:45:14.252Z` · latest `2026.9.3` / `f7a36e6e87`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `2ms` | `93MB` | `113MB` | ok: gateway RPC |
| Control UI | `241ms` | `317ms` | `509MB` | `1,025MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-09T11:11:19.988Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.3` | - | - | `4,983MB` | `4,983MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,189MB` | `5,189MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,061MB` | `5,061MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,018MB` | `5,018MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,228MB` | `5,228MB` | failed: QA command exited with status 1 after producing a missing summary. |
