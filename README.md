...
Latest imported channel run: `2026-06-12T13:24:19.822Z` · latest `2026.6.2` / `0fc5a57a34`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `997ms` | `7,331ms` | `137MB` | `137MB` | ok |
| Discord | `1,969ms` | `2,074ms` | `927MB` | `966MB` | ok |
| Slack | `3,186ms` | `3,738ms` | `983MB` | `993MB` | ok |
...
Latest imported surface run: `2026-06-12T13:41:13.385Z` · latest `2026.6.2` / `0fc5a57a34`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `11ms` | `16ms` | `174MB` | `187MB` | ok: gateway RPC |
| Control UI | `333ms` | `364ms` | `440MB` | `1,104MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-12T13:45:18.208Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.6.6` | `366ms` | `1,038ms` | - | - | - | - | `307ms` |
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.6.6` | - | - | - | - | missing: no imported run |
