...
Latest imported surface run: `2026-07-07T07:42:54.093Z` · latest `2026.6.11` / `5c4b63964c`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `5ms` | `9ms` | `174MB` | `184MB` | ok: gateway RPC |
| Control UI | `291ms` | `401ms` | `452MB` | `933MB` | ok: browser/Gateway |
