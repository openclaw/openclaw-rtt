...
Latest imported channel run: `2026-06-22T09:07:30.286Z` · latest `2026.6.9` / `95093303c8`
...
| Slack | `3,153ms` | `4,512ms` | `982MB` | `991MB` | stale: latest failed; showing last pass (failed) |
