...
Latest imported channel run: `2026-06-13T07:30:28.413Z` · latest `2026.6.2` / `7c08804541`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,011ms` | `4,737ms` | `136MB` | `136MB` | ok |
...
Latest imported surface run: `2026-06-13T01:30:25.349Z` · latest `2026.6.2` / `0063f3076c`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `12ms` | `15ms` | `182MB` | `187MB` | ok: gateway RPC |
| Control UI | `400ms` | `407ms` | `447MB` | `1,116MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-12T14:33:39.940Z`
