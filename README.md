...
Latest imported release coverage run: `2026-09-20T23:15:02.226Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.5` | - | - | `5,396MB` | `5,396MB` | failed |
| `2026.9.4` | - | - | `5,399MB` | `5,399MB` | failed |
| `2026.9.3` | - | - | `5,293MB` | `5,293MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,466MB` | `5,466MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,506MB` | `5,506MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,292MB` | `5,292MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,499MB` | `5,499MB` | failed: QA command exited with status 1 after producing a missing summary. |
