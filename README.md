...
Latest imported channel run: `2026-07-18T04:28:36.765Z` · latest `2026.7.2` / `2a2e97b960`
...
Latest imported surface run: `2026-07-18T03:55:36.317Z` · latest `2026.7.2` / `3659c85e53`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `13ms` | `13ms` | `162MB` | `162MB` | ok: gateway RPC |
| Control UI | `324ms` | `324ms` | `1,160MB` | `1,160MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-18T05:06:01.300Z`
...
Latest imported surface run: `2026-07-18T03:57:29.998Z`
...
| `2026.6.8-beta.1` | - | - | `619MB` | `619MB` | failed |
| `2026.6.7-beta.1` | - | - | `621MB` | `621MB` | failed |
| `2026.6.6` | - | - | `610MB` | `610MB` | failed: QA command exited with status 0 before writing a summary. |
| `2026.6.6-beta.2` | - | - | `595MB` | `595MB` | failed: QA command exited with status 0 before writing a summary. |
