...
Latest imported surface run: `2026-08-08T06:44:43.719Z` · latest `2026.8.1` / `c7b7fe4c32`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `3ms` | `175MB` | `203MB` | ok: gateway RPC |
| Control UI | `192ms` | `202ms` | `502MB` | `1,143MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-08-08T02:51:27.380Z`
...
| `2026.7.2-beta.3` | - | - | `1,203MB` | `1,203MB` | failed |
| `2026.7.2-beta.2` | - | - | `1,085MB` | `1,085MB` | failed |
...
| `2026.5.18-beta.1` | - | - | `732MB` | `732MB` | failed: QA command exited with status 0 before writing a summary. |
