...
Latest imported channel run: `2026-07-25T01:21:55.231Z` · latest `2026.7.2` / `ab04b2103e`
...
Latest imported surface run: `2026-07-25T01:00:34.992Z` · latest `2026.7.2` / `4e51e7adda`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `8ms` | `9ms` | `190MB` | `199MB` | ok: gateway RPC |
| Control UI | `103ms` | `112ms` | `496MB` | `1,141MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-25T02:58:19.791Z`
...
Latest imported surface run: `2026-07-24T08:02:52.629Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.4` | - | - | `1,139MB` | `1,175MB` | failed |
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.4` | - | - | `1,146MB` | `1,146MB` | failed |
| `2026.7.2-beta.3` | - | - | `735MB` | `735MB` | failed: QA command exited with status 1 before writing a summary. |
| `2026.7.2-beta.2` | - | - | `1,169MB` | `1,169MB` | failed |
