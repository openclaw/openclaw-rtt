...
Latest imported channel run: `2026-07-12T18:52:13.468Z` · latest `2026.7.2` / `3e68035de1`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,894ms` | `2,156ms` | `1,025MB` | `1,148MB` | ok |
| Slack | `3,139ms` | `3,139ms` | `913MB` | `913MB` | ok |
...
Latest imported surface run: `2026-07-12T18:45:10.398Z` · latest `2026.7.2` / `36e81bf45e`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `6ms` | `10ms` | `175MB` | `184MB` | ok: gateway RPC |
| Control UI | `287ms` | `335ms` | `480MB` | `1,123MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-12T13:52:25.258Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `1,022MB` | `1,028MB` | timeout |
| `2026.5.16-beta.5` | - | - | `1,013MB` | `1,025MB` | timeout |
...
| `2026.6.7-beta.1` | - | - | `613MB` | `613MB` | failed |
