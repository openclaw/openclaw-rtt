...
Latest imported channel run: `2026-06-09T19:34:09.510Z` · latest `2026.6.2` / `a2dd821908`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,023ms` | `2,359ms` | `137MB` | `137MB` | ok |
| Discord | `1,821ms` | `1,971ms` | `1,034MB` | `1,137MB` | ok |
| Slack | `3,149ms` | `4,412ms` | `1,022MB` | `1,042MB` | ok |
| WhatsApp | `3,333ms` | `4,011ms` | `1,065MB` | `1,143MB` | ok |
...
Latest imported surface run: `2026-06-09T19:14:43.625Z` · latest `2026.6.2` / `8b84e951e5`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `4ms` | `14ms` | `174MB` | `183MB` | ok: gateway RPC |
| Control UI | `405ms` | `414ms` | `447MB` | `1,087MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-09T19:23:36.284Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.6.5` | `347ms` | `1,002ms` | - | - | - | - | `308ms` |
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.6.5` | - | - | - | - | missing: no imported run |
