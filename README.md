...
Latest imported channel run: `2026-09-14T07:28:53.891Z` · latest `2026.9.4` / `b2fefda199`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,003ms` | `2,002ms` | `87MB` | `87MB` | ok |
| Discord | `1,942ms` | `2,109ms` | `1,014MB` | `1,040MB` | ok |
| Slack | `2,819ms` | `2,903ms` | `911MB` | `925MB` | ok |
...
Latest imported surface run: `2026-09-14T07:00:38.187Z` · latest `2026.9.4` / `919232b92c`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `93MB` | `112MB` | ok: gateway RPC |
| Control UI | `175ms` | `277ms` | `524MB` | `1,034MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-14T05:32:37.040Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,312MB` | `5,312MB` | failed |
| `2026.9.3` | - | - | `5,396MB` | `5,396MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,267MB` | `5,267MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,404MB` | `5,404MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,466MB` | `5,466MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,428MB` | `5,428MB` | failed: QA command exited with status 1 after producing a missing summary. |
