...
Latest imported channel run: `2026-09-08T19:11:30.031Z` · latest `2026.9.3` / `3b5abfff3c`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `999ms` | `2,008ms` | `87MB` | `87MB` | ok |
| Discord | `2,260ms` | `2,603ms` | `664MB` | `736MB` | ok |
| Slack | `3,338ms` | `6,477ms` | `670MB` | `709MB` | ok |
...
Latest imported surface run: `2026-09-08T18:40:41.479Z` · latest `2026.9.3` / `5ce97daef8`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `93MB` | `113MB` | ok: gateway RPC |
| Control UI | `211ms` | `364ms` | `511MB` | `973MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-08T19:07:43.166Z`
...
| `2026.6.6-beta.2` | - | - | `4,917MB` | `4,917MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,389MB` | `5,389MB` | failed: QA command exited with status 1 after producing a missing summary. |
