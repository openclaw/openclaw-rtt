...
Latest imported channel run: `2026-06-16T08:45:03.226Z` · latest `2026.6.2` / `c14793d35a`
...
Latest imported surface run: `2026-06-16T14:16:15.504Z` · latest `2026.6.2` / `47ce7bc581`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `17ms` | `41ms` | `181MB` | `184MB` | ok: gateway RPC |
| Control UI | `328ms` | `435ms` | `450MB` | `1,095MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-16T08:34:11.277Z`
...
Latest imported surface run: `2026-06-16T08:34:11.277Z`
