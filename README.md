...
Latest imported release coverage run: `2026-07-27T15:36:29.404Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.4` | - | - | `1,190MB` | `1,190MB` | failed |
| `2026.7.2-beta.3` | - | - | `1,187MB` | `1,187MB` | failed |
| `2026.7.2-beta.2` | - | - | `1,153MB` | `1,153MB` | failed |
