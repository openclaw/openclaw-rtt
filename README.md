...
Latest imported channel run: `2026-06-12T08:17:39.894Z` · latest `2026.6.2` / `d4819948f3`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,086ms` | `1,987ms` | `137MB` | `137MB` | ok |
...
Latest imported surface run: `2026-06-12T08:06:01.818Z` · latest `2026.6.2` / `d4819948f3`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `10ms` | `35ms` | `174MB` | `184MB` | ok: gateway RPC |
| Control UI | `301ms` | `419ms` | `449MB` | `1,079MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-12T08:42:15.328Z`
...
Latest imported surface run: `2026-06-12T08:08:50.742Z`
