...
Latest imported channel run: `2026-07-07T13:39:19.313Z` · latest `2026.6.11` / `b95b9e4487`
...
Latest imported surface run: `2026-07-07T13:14:28.988Z` · latest `2026.6.11` / `cd86107a10`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `6ms` | `21ms` | `176MB` | `184MB` | ok: gateway RPC |
| Control UI | `311ms` | `325ms` | `456MB` | `937MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-07T08:46:39.296Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.1-beta.2` | - | - | `628MB` | `628MB` | failed |
...
| `2026.6.6` | - | - | `594MB` | `594MB` | failed: QA command exited with status 0 before writing a summary. |
