...
Latest imported channel run: `2026-06-25T08:12:57.578Z` · latest `2026.6.10` / `770b19f496`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,741ms` | `1,949ms` | `1,203MB` | `1,232MB` | ok |
| Slack | `3,280ms` | `3,280ms` | `1,060MB` | `1,060MB` | ok |
...
Latest imported surface run: `2026-06-25T07:43:22.614Z` · latest `2026.6.10` / `31e941c3fc`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `10ms` | `35ms` | `174MB` | `183MB` | ok: gateway RPC |
| Control UI | `339ms` | `347ms` | `451MB` | `909MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-25T08:35:05.325Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `778MB` | `794MB` | timeout |
| `2026.5.16-beta.5` | - | - | `778MB` | `782MB` | timeout |
