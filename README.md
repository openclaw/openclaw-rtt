...
Latest imported channel run: `2026-09-06T01:30:38.845Z` · latest `2026.9.2` / `e8c3445253`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,000ms` | `2,004ms` | `86MB` | `86MB` | ok |
| Discord | `1,566ms` | `2,370ms` | `753MB` | `767MB` | ok |
| Slack | `1,891ms` | `3,303ms` | `685MB` | `709MB` | ok |
...
Latest imported surface run: `2026-09-06T01:12:06.017Z` · latest `2026.9.2` / `d85142c709`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `93MB` | `111MB` | ok: gateway RPC |
| Control UI | `126ms` | `159ms` | `516MB` | `1,034MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-06T01:17:46.244Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.9.2` | `1,338ms` | `1,001ms` | - | `3,328ms` | fail | `0ms` | `112ms` |
...
Latest imported surface run: `2026-09-06T01:17:46.244Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.2` | - | - | - | - | missing: no imported run |
...
| `2026.6.8-beta.2` | - | - | `5,352MB` | `5,352MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,478MB` | `5,478MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,397MB` | `5,397MB` | failed: QA command exited with status 1 after producing a missing summary. |
