...
Latest imported channel run: `2026-07-05T07:55:48.722Z` · latest `2026.6.11` / `c64a306f90`
...
Latest imported surface run: `2026-07-05T12:53:37.646Z` · latest `2026.6.11` / `e29448df08`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `5ms` | `8ms` | `173MB` | `183MB` | ok: gateway RPC |
| Control UI | `298ms` | `335ms` | `447MB` | `932MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-05T12:43:49.013Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.7.1-beta.2` | - | `1,992ms` | - | - | - | - | - |
...
| `2026.6.8-beta.1` | - | - | `598MB` | `598MB` | failed |
| `2026.6.7-beta.1` | - | - | `605MB` | `605MB` | failed |
| `2026.6.6` | - | - | `603MB` | `603MB` | failed: QA command exited with status 0 before writing a summary. |
| `2026.6.6-beta.2` | - | - | `598MB` | `598MB` | failed: QA command exited with status 0 before writing a summary. |
