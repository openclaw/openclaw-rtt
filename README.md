...
Latest imported channel run: `2026-07-30T01:04:51.187Z` · latest `2026.7.2` / `545350488a`
...
Latest imported surface run: `2026-07-30T00:57:39.989Z` · latest `2026.7.2` / `06a5b974ad`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `189MB` | `194MB` | ok: gateway RPC |
| Control UI | `200ms` | `371ms` | `484MB` | `1,162MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-29T21:20:48.591Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.5` | - | - | `1,270MB` | `1,388MB` | failed |
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.5` | - | - | `1,232MB` | `1,232MB` | failed |
| `2026.7.2-beta.4` | - | - | `1,286MB` | `1,286MB` | failed |
| `2026.7.2-beta.3` | - | - | `1,153MB` | `1,153MB` | failed |
| `2026.7.2-beta.2` | - | - | `1,054MB` | `1,054MB` | failed |
...
| `2026.6.9` | - | - | `668MB` | `668MB` | failed |
| `2026.6.9-beta.1` | - | - | `668MB` | `668MB` | failed |
| `2026.6.8` | - | - | `655MB` | `655MB` | failed |
