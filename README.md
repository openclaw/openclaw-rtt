...
Latest imported channel run: `2026-05-17T07:58:22.570Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp |
|---|---:|---:|---:|---:|---:|
| `2026.5.16-beta.4` | `12,521ms` | `1,221ms` | `26,263ms` | - | - |
...
| `2026.4.27` | `4,639ms` | `13,664ms` | - | - |
| `2026.4.26` | `5,880ms` | `18,610ms` | - | - |
