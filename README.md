...
Latest imported channel run: `2026-07-09T07:48:58.667Z` · latest `2026.6.11` / `f0d4d4f2fc`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,692ms` | `1,922ms` | `1,193MB` | `1,223MB` | ok |
...
Latest imported surface run: `2026-07-09T07:42:28.712Z` · latest `2026.6.11` / `e5aefd5656`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `5ms` | `8ms` | `174MB` | `183MB` | ok: gateway RPC |
| Control UI | `280ms` | `336ms` | `451MB` | `963MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-09T01:59:12.316Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `906MB` | `946MB` | timeout |
| `2026.5.16-beta.5` | - | - | `901MB` | `955MB` | timeout |
...
| `2026.6.8-beta.1` | - | - | `631MB` | `631MB` | failed |
