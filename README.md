...
Latest imported channel run: `2026-07-06T14:19:01.990Z` · latest `2026.6.11` / `3442a8e6f5`
...
Latest imported surface run: `2026-07-06T13:44:03.186Z` · latest `2026.6.11` / `e35c7a3c95`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `6ms` | `27ms` | `173MB` | `183MB` | ok: gateway RPC |
| Control UI | `303ms` | `338ms` | `449MB` | `948MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-06T14:53:00.613Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.1-beta.2` | - | - | `637MB` | `637MB` | failed |
...
| `2026.6.8-beta.1` | - | - | `591MB` | `591MB` | failed |
| `2026.6.7-beta.1` | - | - | `584MB` | `584MB` | failed |
| `2026.6.6` | - | - | `589MB` | `589MB` | failed: QA command exited with status 0 before writing a summary. |
| `2026.6.6-beta.2` | - | - | `575MB` | `575MB` | failed: QA command exited with status 0 before writing a summary. |
