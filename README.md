...
Latest imported channel run: `2026-07-22T01:20:00.328Z` · latest `2026.7.2` / `0f066eec81`
...
Latest imported surface run: `2026-07-22T00:58:18.715Z` · latest `2026.7.2` / `0baf0495ab`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `6ms` | `8ms` | `164MB` | `171MB` | ok: gateway RPC |
| Control UI | `135ms` | `374ms` | `483MB` | `1,029MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-22T01:36:21.832Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.3` | - | - | `1,253MB` | `1,253MB` | failed |
