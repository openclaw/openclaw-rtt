...
Latest imported channel run: `2026-07-09T13:35:07.623Z` · latest `2026.6.11` / `474d660137`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,916ms` | `2,044ms` | `1,053MB` | `1,172MB` | ok |
| Slack | `2,906ms` | `2,906ms` | `943MB` | `943MB` | ok |
...
Latest imported surface run: `2026-07-09T13:30:36.263Z` · latest `2026.6.11` / `25e18fc3b5`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `6ms` | `11ms` | `182MB` | `183MB` | ok: gateway RPC |
| Control UI | `340ms` | `377ms` | `455MB` | `925MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-09T08:43:46.614Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `935MB` | `960MB` | timeout |
| `2026.5.16-beta.5` | - | - | `947MB` | `972MB` | timeout |
