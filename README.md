...
Latest imported channel run: `2026-09-11T12:52:31.370Z` · latest `2026.9.4` / `4407ed19ac`
...
Latest imported release coverage run: `2026-09-11T11:33:47.384Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,414MB` | `5,414MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,279MB` | `5,279MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,032MB` | `5,032MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `4,873MB` | `4,873MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,154MB` | `5,154MB` | failed: QA command exited with status 1 after producing a missing summary. |
