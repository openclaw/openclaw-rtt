...
Latest imported channel run: `2026-08-03T13:35:38.594Z` · latest `2026.7.2` / `1acc64b28a`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,041ms` | `2,028ms` | `149MB` | `149MB` | ok |
| Discord | `3,991ms` | `4,376ms` | `3,142MB` | `3,166MB` | ok |
...
Latest imported release coverage run: `2026-08-03T09:51:06.189Z`
...
| `2026.5.18-beta.1` | - | - | `684MB` | `684MB` | failed: QA command exited with status 0 before writing a summary. |
| `2026.5.16-beta.7` | `4,704ms` | `6,118ms` | `699MB` | `762MB` | ok |
| `2026.5.16-beta.6` | `4,719ms` | `5,051ms` | `724MB` | `760MB` | ok |
| `2026.5.16-beta.5` | `4,703ms` | `4,791ms` | `683MB` | `683MB` | failed: QA command exited with status 0 before writing a summary. |
