...
Latest imported channel run: `2026-06-28T01:38:27.931Z` · latest `2026.6.10` / `78f7de01c1`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,784ms` | `1,908ms` | `1,217MB` | `1,254MB` | ok |
| Slack | `3,328ms` | `3,328ms` | `1,060MB` | `1,060MB` | ok |
...
Latest imported surface run: `2026-06-28T01:28:43.508Z` · latest `2026.6.10` / `3630d502eb`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `5ms` | `10ms` | `175MB` | `184MB` | ok: gateway RPC |
| Control UI | `412ms` | `416ms` | `450MB` | `924MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-28T02:05:05.914Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `778MB` | `788MB` | timeout |
| `2026.5.16-beta.5` | - | - | `779MB` | `789MB` | timeout |
...
| `2026.6.8-beta.1` | - | - | `614MB` | `614MB` | failed |
| `2026.6.7-beta.1` | - | - | `617MB` | `617MB` | failed |
| `2026.6.6` | - | - | `619MB` | `619MB` | failed: QA command exited with status 0 before writing a summary. |
