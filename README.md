...
Latest imported channel run: `2026-09-20T07:16:26.258Z` · latest `2026.9.5` / `d55f4cf342`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,001ms` | `2,007ms` | `87MB` | `87MB` | ok |
| Discord | `2,411ms` | `2,736ms` | `1,176MB` | `1,189MB` | ok |
| Slack | `3,326ms` | `3,444ms` | `1,053MB` | `1,062MB` | ok |
...
Latest imported surface run: `2026-09-20T06:46:11.787Z` · latest `2026.9.5` / `d0192ed506`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `90MB` | `109MB` | ok: gateway RPC |
| Control UI | `237ms` | `632ms` | `520MB` | `1,077MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-20T11:18:13.928Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.5` | - | - | `5,441MB` | `5,441MB` | failed |
| `2026.9.4` | - | - | `5,456MB` | `5,456MB` | failed |
| `2026.9.3` | - | - | `5,266MB` | `5,266MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,304MB` | `5,304MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,300MB` | `5,300MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,426MB` | `5,426MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,450MB` | `5,450MB` | failed: QA command exited with status 1 after producing a missing summary. |
