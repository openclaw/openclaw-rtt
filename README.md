...
Latest imported channel run: `2026-09-17T07:24:45.641Z` · latest `2026.9.4` / `68b4251368`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,001ms` | `2,007ms` | `87MB` | `87MB` | ok |
| Discord | `1,562ms` | `1,776ms` | `983MB` | `1,071MB` | ok |
| Slack | `2,923ms` | `2,960ms` | `953MB` | `1,065MB` | ok |
...
Latest imported surface run: `2026-09-17T12:46:53.171Z` · latest `2026.9.4` / `3c0fb2025a`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `2ms` | `91MB` | `110MB` | ok: gateway RPC |
| Control UI | `333ms` | `477ms` | `545MB` | `1,136MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-17T11:51:30.682Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `4,915MB` | `4,915MB` | failed |
| `2026.9.3` | - | - | `5,245MB` | `5,245MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,120MB` | `5,120MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,195MB` | `5,195MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `4,964MB` | `4,964MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,177MB` | `5,177MB` | failed: QA command exited with status 1 after producing a missing summary. |
