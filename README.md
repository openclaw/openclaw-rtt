...
Latest imported channel run: `2026-06-21T19:15:08.774Z` · latest `2026.6.9` / `102ab759e7`
...
Latest imported surface run: `2026-06-22T01:37:16.611Z` · latest `2026.6.9` / `adb9abe721`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `6ms` | `18ms` | `183MB` | `184MB` | ok: gateway RPC |
| Control UI | `412ms` | `458ms` | `457MB` | `1,103MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-22T04:08:47.373Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.6.10-beta.1` | `732ms` | `1,955ms` | `1,971ms` | fail | fail | - | `411ms` |
