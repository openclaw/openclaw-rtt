...
Latest imported channel run: `2026-09-20T01:36:35.850Z` · latest `2026.9.5` / `87fdeff3bd`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,001ms` | `2,007ms` | `87MB` | `87MB` | ok |
| Discord | `1,629ms` | `1,857ms` | `1,170MB` | `1,181MB` | ok |
| Slack | `3,289ms` | `3,357ms` | `1,051MB` | `1,066MB` | ok |
...
Latest imported surface run: `2026-09-20T01:13:01.859Z` · latest `2026.9.5` / `8ebc8cd021`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `91MB` | `110MB` | ok: gateway RPC |
| Control UI | `250ms` | `308ms` | `527MB` | `1,134MB` | ok: browser/Gateway |
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.5` | - | - | `5,338MB` | `5,338MB` | failed |
| `2026.9.4` | - | - | `5,305MB` | `5,305MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,439MB` | `5,439MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,530MB` | `5,530MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,314MB` | `5,314MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,352MB` | `5,352MB` | failed: QA command exited with status 1 after producing a missing summary. |
