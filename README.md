...
Latest imported channel run: `2026-09-12T13:07:39.956Z` · latest `2026.9.4` / `d8af54cc6c`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,003ms` | `2,002ms` | `87MB` | `87MB` | ok |
| Discord | `2,443ms` | `2,664ms` | `1,050MB` | `1,058MB` | ok |
| Slack | `3,291ms` | `3,384ms` | `920MB` | `936MB` | ok |
...
Latest imported release coverage run: `2026-09-12T17:02:06.194Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,314MB` | `5,314MB` | failed |
| `2026.9.3` | - | - | `5,451MB` | `5,451MB` | failed |
...
| `2026.6.6` | - | - | `5,429MB` | `5,429MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,432MB` | `5,432MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,402MB` | `5,402MB` | failed: QA command exited with status 1 after producing a missing summary. |
