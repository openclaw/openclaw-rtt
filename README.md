...
Latest imported channel run: `2026-06-13T13:18:35.001Z` · latest `2026.6.2` / `dc493bc9a2`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | ok |
...
Latest imported surface run: `2026-06-13T13:02:08.587Z` · latest `2026.6.2` / `4c23d1d597`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `10ms` | `11ms` | `174MB` | `183MB` | ok: gateway RPC |
| Control UI | `407ms` | `417ms` | `441MB` | `1,072MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-13T13:37:24.306Z`
...
Latest imported surface run: `2026-06-13T13:07:49.830Z`
