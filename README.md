...
Latest imported release coverage run: `2026-07-22T09:13:08.169Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.3` | - | - | `1,160MB` | `1,160MB` | failed |
...
| `2026.6.9-beta.1` | - | - | `662MB` | `662MB` | failed |
| `2026.6.8` | - | - | `664MB` | `664MB` | failed |
| `2026.6.8-beta.2` | - | - | `610MB` | `610MB` | failed |
