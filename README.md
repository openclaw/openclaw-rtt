...
Latest imported channel run: `2026-07-11T01:03:49.980Z` · latest `2026.6.11` / `d777460966`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `2,017ms` | `2,270ms` | `1,174MB` | `1,195MB` | ok |
...
Latest imported surface run: `2026-07-11T00:58:30.580Z` · latest `2026.6.11` / `95b205eac2`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `6ms` | `19ms` | `174MB` | `184MB` | ok: gateway RPC |
| Control UI | `305ms` | `344ms` | `461MB` | `949MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-10T19:56:21.961Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `952MB` | `1,004MB` | timeout |
| `2026.5.16-beta.5` | - | - | `948MB` | `981MB` | timeout |
...
| `2026.6.6` | - | - | `611MB` | `611MB` | failed: QA command exited with status 0 before writing a summary. |
