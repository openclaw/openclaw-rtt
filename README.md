...
Latest imported channel run: `2026-07-10T01:25:48.906Z` · latest `2026.6.11` / `28eb9e5d29`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,750ms` | `1,964ms` | `1,054MB` | `1,143MB` | ok |
| Slack | `3,329ms` | `3,329ms` | `877MB` | `877MB` | ok |
...
Latest imported surface run: `2026-07-10T01:04:18.864Z` · latest `2026.6.11` / `9e6900fc9f`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `5ms` | `35ms` | `174MB` | `183MB` | ok: gateway RPC |
| Control UI | `282ms` | `307ms` | `451MB` | `949MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-10T01:56:42.377Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `952MB` | `966MB` | timeout |
| `2026.5.16-beta.5` | - | - | `988MB` | `997MB` | timeout |
...
| `2026.6.8-beta.1` | - | - | `633MB` | `633MB` | failed |
