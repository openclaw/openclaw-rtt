...
Latest imported channel run: `2026-09-10T00:49:53.009Z` · latest `2026.9.3` / `c9b30878a6`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,002ms` | `2,002ms` | `86MB` | `86MB` | ok |
| Discord | `1,870ms` | `2,352ms` | `683MB` | `709MB` | ok |
| Slack | `2,943ms` | `3,326ms` | `677MB` | `695MB` | ok |
...
Latest imported surface run: `2026-09-09T18:40:24.640Z` · latest `2026.9.3` / `cc81bfade7`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `4ms` | `91MB` | `111MB` | ok: gateway RPC |
| Control UI | `266ms` | `299ms` | `507MB` | `1,038MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-09T23:03:30.500Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.3` | - | - | `5,388MB` | `5,388MB` | failed |
...
| `2026.6.6-beta.2` | - | - | `5,154MB` | `5,154MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,306MB` | `5,306MB` | failed: QA command exited with status 1 after producing a missing summary. |
