...
Latest imported channel run: `2026-06-30T01:49:24.451Z` · latest `2026.6.10` / `54b09580f6`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,909ms` | `2,008ms` | `1,159MB` | `1,183MB` | ok |
| Slack | `3,301ms` | `3,301ms` | `1,069MB` | `1,069MB` | stale: latest failed; showing last pass (failed) |
...
Latest imported surface run: `2026-06-30T01:24:22.652Z` · latest `2026.6.10` / `54b09580f6`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `5ms` | `7ms` | `174MB` | `185MB` | ok: gateway RPC |
| Control UI | `410ms` | `419ms` | `448MB` | `922MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-29T19:55:15.650Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `783MB` | `806MB` | timeout |
| `2026.5.16-beta.5` | - | - | `780MB` | `789MB` | timeout |
...
| `2026.6.8-beta.1` | - | - | `622MB` | `622MB` | failed |
| `2026.6.7-beta.1` | - | - | `619MB` | `619MB` | failed |
| `2026.6.6` | - | - | `605MB` | `605MB` | failed: QA command exited with status 0 before writing a summary. |
