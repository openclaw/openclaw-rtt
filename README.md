...
Latest imported channel run: `2026-06-19T01:46:03.552Z` · latest `2026.6.8` / `39297fb0ad`
...
Latest imported surface run: `2026-06-19T08:21:15.404Z` · latest `2026.6.8` / `44b0644e88`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `6ms` | `25ms` | `174MB` | `183MB` | ok: gateway RPC |
| Control UI | `341ms` | `429ms` | `456MB` | `1,062MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-19T08:25:54.781Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.6.9-beta.1` | `783ms` | `1,970ms` | - | - | - | - | `405ms` |
...
Latest imported surface run: `2026-06-19T08:25:54.781Z`
