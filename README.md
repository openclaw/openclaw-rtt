...
Latest imported channel run: `2026-08-02T12:55:06.492Z` · latest `2026.7.2` / `aa02128aca`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,025ms` | `2,034ms` | `150MB` | `150MB` | ok |
| Discord | `4,135ms` | `4,400ms` | `3,138MB` | `3,169MB` | ok |
| Slack | `4,779ms` | `4,779ms` | `3,224MB` | `3,224MB` | ok |
...
Latest imported surface run: `2026-07-31T18:57:40.603Z` · latest `2026.7.2` / `8203220bb4`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `188MB` | `192MB` | ok: gateway RPC |
| Control UI | `196ms` | `270ms` | `473MB` | `1,158MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-08-02T12:55:32.147Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.7.2-beta.7` | `456ms` | `1,020ms` | - | fail | fail | - | `109ms` |
...
Latest imported surface run: `2026-08-02T12:55:32.147Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.7` | - | - | - | - | missing: no imported run |
...
| `2026.7.2-beta.3` | - | - | `1,144MB` | `1,144MB` | failed |
| `2026.7.2-beta.2` | - | - | `1,065MB` | `1,065MB` | failed |
...
| `2026.5.18-beta.1` | - | - | `752MB` | `752MB` | failed: QA command exited with status 0 before writing a summary. |
...
| `2026.6.6-beta.2` | - | - | `659MB` | `659MB` | failed: QA command exited with status 0 before writing a summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `613MB` | `613MB` | failed: QA command exited with status 0 before writing a summary. |
