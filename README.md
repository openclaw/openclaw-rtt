...
Latest imported channel run: `2026-09-05T18:23:51.778Z` · latest `2026.9.1` / `717f824924`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,001ms` | `2,005ms` | `86MB` | `86MB` | ok |
| Discord | `1,555ms` | `1,715ms` | `747MB` | `758MB` | ok |
| Slack | `1,891ms` | `3,339ms` | `680MB` | `698MB` | ok |
...
Latest imported surface run: `2026-09-05T12:38:21.212Z` · latest `2026.9.1` / `5300e70956`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `92MB` | `111MB` | ok: gateway RPC |
| Control UI | `127ms` | `382ms` | `518MB` | `1,016MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-05T16:17:25.877Z`
