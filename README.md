...
Latest imported surface run: `2026-09-20T18:36:20.387Z` · latest `2026.9.5` / `8b8d1c5597`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `2ms` | `91MB` | `110MB` | ok: gateway RPC |
| Control UI | `245ms` | `307ms` | `524MB` | `973MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-20T17:13:39.486Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.5` | - | - | `5,317MB` | `5,317MB` | failed |
| `2026.9.4` | - | - | `5,410MB` | `5,410MB` | failed |
| `2026.9.3` | - | - | `5,461MB` | `5,461MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,432MB` | `5,432MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,501MB` | `5,501MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,413MB` | `5,413MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,401MB` | `5,401MB` | failed: QA command exited with status 1 after producing a missing summary. |
