...
Latest imported channel run: `2026-09-05T01:09:56.992Z` · latest `2026.9.1` / `061036abda`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,000ms` | `2,008ms` | `87MB` | `87MB` | ok |
| Discord | `1,385ms` | `1,708ms` | `652MB` | `668MB` | ok |
| Slack | `3,336ms` | `3,381ms` | `611MB` | `626MB` | ok |
...
Latest imported surface run: `2026-09-05T01:03:35.387Z` · latest `2026.9.1` / `061036abda`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `93MB` | `113MB` | ok: gateway RPC |
| Control UI | `153ms` | `268ms` | `510MB` | `1,004MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-04T22:36:37.062Z`
...
| `2026.6.6` | - | - | `5,208MB` | `5,208MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `4,962MB` | `4,962MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,287MB` | `5,287MB` | failed: QA command exited with status 1 after producing a missing summary. |
