...
Latest imported channel run: `2026-07-15T18:53:09.592Z` · latest `2026.7.2` / `ff4d854167`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,783ms` | `1,945ms` | `1,021MB` | `1,037MB` | ok |
...
Latest imported release coverage run: `2026-07-15T18:55:30.414Z`
...
Latest imported surface run: `2026-07-15T18:55:30.414Z`
...
| `2026.6.8-beta.1` | - | - | `613MB` | `613MB` | failed |
| `2026.6.7-beta.1` | - | - | `620MB` | `620MB` | failed |
| `2026.6.6` | - | - | `609MB` | `609MB` | failed: QA command exited with status 0 before writing a summary. |
| `2026.6.6-beta.2` | - | - | `611MB` | `611MB` | failed: QA command exited with status 0 before writing a summary. |
