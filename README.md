...
Latest imported surface run: `2026-07-19T18:45:39.106Z` · latest `2026.7.2` / `163a6c6e16`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `4ms` | `5ms` | `162MB` | `167MB` | ok: gateway RPC |
| Control UI | `314ms` | `328ms` | `473MB` | `987MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-20T02:39:32.544Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.3` | - | - | `1,119MB` | `1,119MB` | failed |
| `2026.7.2-beta.2` | - | - | `1,095MB` | `1,095MB` | failed |
...
| `2026.6.6` | - | - | `650MB` | `650MB` | failed: QA command exited with status 0 before writing a summary. |
| `2026.6.6-beta.2` | - | - | `660MB` | `660MB` | failed: QA command exited with status 0 before writing a summary. |
