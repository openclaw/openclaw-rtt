...
Latest imported channel run: `2026-07-22T08:01:28.591Z` · latest `2026.7.2` / `eab05ddffb`
...
Latest imported surface run: `2026-07-22T07:22:56.932Z` · latest `2026.7.2` / `f2a3371656`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `9ms` | `27ms` | `163MB` | `169MB` | ok: gateway RPC |
| Control UI | `139ms` | `161ms` | `491MB` | `1,048MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-22T02:44:28.288Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.3` | - | - | `1,097MB` | `1,097MB` | failed |
| `2026.7.2-beta.2` | - | - | `1,087MB` | `1,087MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `627MB` | `627MB` | failed |
