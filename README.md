...
Latest imported channel run: `2026-07-26T13:18:14.680Z` · latest `2026.7.2` / `354c6db731`
...
Latest imported surface run: `2026-07-26T12:48:38.525Z` · latest `2026.7.2` / `6a11e44497`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `8ms` | `8ms` | `188MB` | `202MB` | ok: gateway RPC |
| Control UI | `103ms` | `111ms` | `492MB` | `1,166MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-26T14:43:44.522Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.4` | - | - | `1,140MB` | `1,140MB` | failed |
| `2026.7.2-beta.3` | - | - | `1,127MB` | `1,127MB` | failed |
| `2026.7.2-beta.2` | - | - | `1,073MB` | `1,073MB` | failed |
