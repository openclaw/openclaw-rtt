...
Latest imported release coverage run: `2026-07-30T02:59:08.880Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.5` | - | - | `1,255MB` | `1,356MB` | failed |
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.5` | - | - | `1,178MB` | `1,178MB` | failed |
| `2026.7.2-beta.4` | - | - | `1,194MB` | `1,194MB` | failed |
| `2026.7.2-beta.3` | - | - | `1,114MB` | `1,114MB` | failed |
| `2026.7.2-beta.2` | - | - | `1,076MB` | `1,076MB` | failed |
...
| `2026.6.9` | - | - | `649MB` | `649MB` | failed |
| `2026.6.9-beta.1` | - | - | `667MB` | `667MB` | failed |
| `2026.6.8` | - | - | `645MB` | `645MB` | failed |
