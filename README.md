...
Latest imported channel run: `2026-09-18T01:33:55.134Z` · latest `2026.9.4` / `c928f7abbf`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,001ms` | `2,007ms` | `87MB` | `87MB` | ok |
| Discord | `1,402ms` | `1,640ms` | `1,025MB` | `1,029MB` | ok |
| Slack | `3,318ms` | `3,418ms` | `991MB` | `1,010MB` | ok |
...
Latest imported surface run: `2026-09-18T06:49:04.857Z` · latest `2026.9.4` / `7bc487d39d`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `3ms` | `6ms` | `94MB` | `107MB` | ok: gateway RPC |
| Control UI | `266ms` | `429ms` | `541MB` | `1,111MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-18T05:14:21.606Z`
