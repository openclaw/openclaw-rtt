...
Latest imported channel run: `2026-07-15T07:19:01.825Z` · latest `2026.7.2` / `d801f2e68c`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,479ms` | `1,589ms` | `1,088MB` | `1,210MB` | ok |
...
Latest imported release coverage run: `2026-07-15T07:34:47.145Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.7.1` | `754ms` | - | `1,797ms` | - | - | - | `290ms` |
...
Latest imported surface run: `2026-07-13T19:02:47.518Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `800MB` | `808MB` | timeout |
| `2026.5.16-beta.5` | - | - | `799MB` | `812MB` | timeout |
...
| `2026.6.8-beta.1` | - | - | `617MB` | `617MB` | failed |
| `2026.6.7-beta.1` | - | - | `612MB` | `612MB` | failed |
| `2026.6.6` | - | - | `615MB` | `615MB` | failed: QA command exited with status 0 before writing a summary. |
| `2026.6.6-beta.2` | - | - | `1,025MB` | `1,025MB` | failed: QA command exited with status 0 before writing a summary. |
