...
Latest imported channel run: `2026-06-02T19:50:35.843Z` · latest `2026.6.2` / `aed3743630`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `990ms` | `16,846ms` | `136MB` | `136MB` | ok |
| Discord | `1,855ms` | `2,029ms` | `963MB` | `1,169MB` | ok |
| Slack | `2,943ms` | `4,220ms` | `955MB` | `970MB` | ok |
| WhatsApp | `3,243ms` | `3,917ms` | `1,010MB` | `1,057MB` | ok |
...
Latest imported surface run: `2026-06-02T19:43:30.421Z` · latest `2026.6.2` / `aed3743630`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `9ms` | `11ms` | `182MB` | `183MB` | ok: gateway RPC |
| Control UI | `296ms` | `405ms` | `449MB` | `1,082MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-02T19:30:26.536Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.6.1-beta.2` | - | `988ms` | - | - | - | - | - |
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.6.1-beta.2` | - | - | - | - | missing: no imported run |
