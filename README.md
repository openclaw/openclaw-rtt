...
Latest imported channel run: `2026-05-18T07:52:03.604Z` · latest `2026.5.17` / `4c613fbfe0`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 |
|---|---:|---:|---:|---:|
| Telegram | `1,088ms` | `2,340ms` | `135MB` | `135MB` |
| Discord | `7,257ms` | `7,498ms` | `768MB` | `780MB` |
...
Latest imported channel run: `2026-05-18T07:57:13.153Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp |
|---|---:|---:|---:|---:|---:|
| `2026.5.16-beta.6` | `1,307ms` | - | `7,844ms` | `4,719ms` | `6,886ms` |
| `2026.5.16-beta.5` | `1,575ms` | - | - | `4,703ms` | `7,853ms` |
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 |
|---|---:|---:|---:|---:|
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `771MB` | `784MB` |
| `2026.5.16-beta.5` | - | - | `768MB` | `779MB` |
