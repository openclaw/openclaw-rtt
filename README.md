...
Latest imported channel run: `2026-09-13T19:10:59.368Z` · latest `2026.9.4` / `6c75805157`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,003ms` | `2,002ms` | `87MB` | `87MB` | ok |
| Discord | `1,936ms` | `2,226ms` | `940MB` | `948MB` | ok |
| Slack | `3,300ms` | `3,341ms` | `809MB` | `828MB` | ok |
...
Latest imported surface run: `2026-09-13T18:35:41.129Z` · latest `2026.9.4` / `29517dc5f3`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `92MB` | `112MB` | ok: gateway RPC |
| Control UI | `143ms` | `154ms` | `523MB` | `1,039MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-13T23:00:50.763Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,417MB` | `5,417MB` | failed |
| `2026.9.3` | - | - | `5,507MB` | `5,507MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,524MB` | `5,524MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.6.6-beta.2` | - | - | `5,448MB` | `5,448MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,466MB` | `5,466MB` | failed: QA command exited with status 1 after producing a missing summary. |
