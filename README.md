...
Latest imported channel run: `2026-09-16T07:22:29.598Z` · latest `2026.9.4` / `ead35525f7`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,001ms` | `2,007ms` | `87MB` | `87MB` | ok |
| Discord | `2,026ms` | `2,380ms` | `1,151MB` | `1,163MB` | ok |
| Slack | `2,874ms` | `3,026ms` | `1,057MB` | `1,069MB` | ok |
...
Latest imported surface run: `2026-09-16T06:50:23.579Z` · latest `2026.9.4` / `fb59f87aa7`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `2ms` | `93MB` | `113MB` | ok: gateway RPC |
| Control UI | `287ms` | `377ms` | `526MB` | `1,040MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-16T05:14:53.885Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,480MB` | `5,480MB` | failed |
| `2026.9.3` | - | - | `5,442MB` | `5,442MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,266MB` | `5,266MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,295MB` | `5,295MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,247MB` | `5,247MB` | failed: QA command exited with status 1 after producing a missing summary. |
