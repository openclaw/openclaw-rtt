...
Latest imported channel run: `2026-07-26T12:51:56.831Z` · latest `2026.7.2` / `6a11e44497`
...
Latest imported release coverage run: `2026-07-26T09:13:33.499Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.4` | - | - | `1,138MB` | `1,138MB` | failed |
| `2026.7.2-beta.3` | - | - | `1,110MB` | `1,110MB` | failed |
| `2026.7.2-beta.2` | - | - | `1,062MB` | `1,062MB` | failed |
...
| `2026.6.9` | - | - | `628MB` | `628MB` | failed |
| `2026.6.9-beta.1` | - | - | `659MB` | `659MB` | failed |
| `2026.6.8` | - | - | `623MB` | `623MB` | failed |
