...
Latest imported channel run: `2026-07-15T13:00:37.955Z` · latest `2026.7.2` / `e58dc0955f`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,710ms` | `1,919ms` | `1,010MB` | `1,048MB` | ok |
...
Latest imported release coverage run: `2026-07-15T13:18:52.818Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `806MB` | `814MB` | timeout |
| `2026.5.16-beta.5` | - | - | `818MB` | `1,034MB` | timeout |
...
| `2026.6.8-beta.1` | - | - | `611MB` | `611MB` | failed |
| `2026.6.7-beta.1` | - | - | `608MB` | `608MB` | failed |
| `2026.6.6` | - | - | `606MB` | `606MB` | failed: QA command exited with status 0 before writing a summary. |
