...
Latest imported channel run: `2026-09-14T13:37:30.609Z` · latest `2026.9.4` / `ac3bd358a8`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,003ms` | `2,002ms` | `87MB` | `87MB` | ok |
| Discord | `2,035ms` | `2,367ms` | `1,017MB` | `1,034MB` | ok |
| Slack | `2,926ms` | `4,496ms` | `911MB` | `939MB` | ok |
...
Latest imported surface run: `2026-09-14T18:38:24.617Z` · latest `2026.9.4` / `eb8f6bb183`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `2ms` | `93MB` | `113MB` | ok: gateway RPC |
| Control UI | `249ms` | `337ms` | `527MB` | `1,043MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-14T18:13:37.114Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,292MB` | `5,292MB` | failed |
| `2026.9.3` | - | - | `5,133MB` | `5,133MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,297MB` | `5,297MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.6.6-beta.2` | - | - | `5,225MB` | `5,225MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `4,890MB` | `4,890MB` | failed: QA command exited with status 1 after producing a missing summary. |
