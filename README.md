...
Latest imported channel run: `2026-06-29T01:40:20.210Z` · latest `2026.6.10` / `31b531e791`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,822ms` | `1,991ms` | `1,170MB` | `1,211MB` | ok |
| Slack | `4,559ms` | `4,559ms` | `1,062MB` | `1,062MB` | ok |
...
Latest imported surface run: `2026-06-29T01:29:46.835Z` · latest `2026.6.10` / `4b8a0a8ecf`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `4ms` | `16ms` | `183MB` | `184MB` | ok: gateway RPC |
| Control UI | `340ms` | `426ms` | `453MB` | `927MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-29T02:15:51.363Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.6.11-beta.2` | `1,253ms` | `988ms` | - | `3,174ms` | - | `3,174ms` | `413ms` |
...
Latest imported surface run: `2026-06-29T02:15:51.363Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `784MB` | `814MB` | timeout |
| `2026.5.16-beta.5` | - | - | `759MB` | `794MB` | timeout |
...
| `2026.6.8-beta.1` | - | - | `610MB` | `610MB` | failed |
| `2026.6.7-beta.1` | - | - | `621MB` | `621MB` | failed |
| `2026.6.6` | - | - | `607MB` | `607MB` | failed: QA command exited with status 0 before writing a summary. |
