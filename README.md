...
Latest imported channel run: `2026-09-21T07:34:09.140Z` · latest `2026.9.5` / `92f2fcfd1a`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,001ms` | `2,007ms` | `87MB` | `87MB` | ok |
| Discord | `2,863ms` | `3,441ms` | `1,165MB` | `1,186MB` | ok |
| Slack | `2,834ms` | `2,901ms` | `1,007MB` | `1,017MB` | ok |
...
Latest imported surface run: `2026-09-21T07:03:26.535Z` · latest `2026.9.5` / `fc1d80aeea`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `4ms` | `90MB` | `110MB` | ok: gateway RPC |
| Control UI | `221ms` | `315ms` | `528MB` | `1,000MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-21T12:17:31.495Z`
