...
Latest imported channel run: `2026-07-26T07:47:47.170Z` · latest `2026.7.2` / `0951d0dd30`
...
Latest imported surface run: `2026-07-26T07:21:34.978Z` · latest `2026.7.2` / `0951d0dd30`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `8ms` | `9ms` | `188MB` | `199MB` | ok: gateway RPC |
| Control UI | `107ms` | `153ms` | `479MB` | `1,173MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-26T02:48:45.729Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.4` | - | - | `1,140MB` | `1,173MB` | failed |
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.4` | - | - | `1,148MB` | `1,148MB` | failed |
| `2026.7.2-beta.3` | - | - | `1,092MB` | `1,092MB` | failed |
| `2026.7.2-beta.2` | - | - | `1,068MB` | `1,068MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `663MB` | `663MB` | failed |
