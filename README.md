...
Latest imported channel run: `2026-09-12T00:50:47.441Z` · latest `2026.9.4` / `db2666090f`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,002ms` | `2,005ms` | `86MB` | `86MB` | ok |
| Discord | `2,237ms` | `2,683ms` | `662MB` | `742MB` | ok |
| Slack | `3,348ms` | `4,453ms` | `648MB` | `670MB` | ok |
...
Latest imported release coverage run: `2026-09-11T23:17:59.402Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,395MB` | `5,395MB` | failed |
| `2026.9.3` | - | - | `5,391MB` | `5,391MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,430MB` | `5,430MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,372MB` | `5,372MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,037MB` | `5,037MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,443MB` | `5,443MB` | failed: QA command exited with status 1 after producing a missing summary. |
