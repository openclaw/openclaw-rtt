...
Latest imported channel run: `2026-08-04T13:15:28.207Z` · latest `2026.7.2` / `b4f01afa86`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,018ms` | `2,117ms` | `149MB` | `149MB` | ok |
| Discord | `3,940ms` | `4,325ms` | `3,140MB` | `3,192MB` | ok |
| Slack | `4,167ms` | `4,167ms` | `3,245MB` | `3,245MB` | ok |
...
Latest imported release coverage run: `2026-08-04T09:29:09.128Z`
...
| `2026.5.18-beta.1` | - | - | `607MB` | `607MB` | failed: QA command exited with status 0 before writing a summary. |
| `2026.5.16-beta.7` | `4,704ms` | `6,118ms` | `699MB` | `762MB` | ok |
| `2026.5.16-beta.6` | `4,719ms` | `5,051ms` | `724MB` | `760MB` | ok |
| `2026.5.16-beta.5` | `4,703ms` | `4,791ms` | `741MB` | `741MB` | failed: QA command exited with status 0 before writing a summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `628MB` | `628MB` | failed: QA command exited with status 0 before writing a summary. |
