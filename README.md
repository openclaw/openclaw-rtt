...
Latest imported surface run: `2026-09-14T12:49:04.784Z` · latest `2026.9.4` / `7cf2696575`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `2ms` | `92MB` | `113MB` | ok: gateway RPC |
| Control UI | `197ms` | `316ms` | `524MB` | `1,049MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-14T12:43:46.341Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,287MB` | `5,287MB` | failed |
| `2026.9.3` | - | - | `5,234MB` | `5,234MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,158MB` | `5,158MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `4,971MB` | `4,971MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,364MB` | `5,364MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,252MB` | `5,252MB` | failed: QA command exited with status 1 after producing a missing summary. |
