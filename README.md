...
Latest imported channel run: `2026-08-04T00:52:14.154Z` · latest `2026.7.2` / `e16bc0108c`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,025ms` | `2,036ms` | `149MB` | `149MB` | ok |
| Discord | `3,943ms` | `4,492ms` | `3,149MB` | `3,172MB` | ok |
| Slack | `4,778ms` | `4,778ms` | `3,208MB` | `3,208MB` | ok |
...
Latest imported release coverage run: `2026-08-03T21:05:45.336Z`
...
| `2026.7.2-beta.3` | - | - | `1,252MB` | `1,252MB` | failed |
| `2026.7.2-beta.2` | - | - | `1,184MB` | `1,184MB` | failed |
...
| `2026.5.16-beta.5` | `4,703ms` | `4,791ms` | `691MB` | `691MB` | failed: QA command exited with status 0 before writing a summary. |
