...
Latest imported channel run: `2026-07-23T01:43:08.491Z` · latest `2026.7.2` / `9636f2aa2d`
...
Latest imported surface run: `2026-07-23T07:21:18.367Z` · latest `2026.7.2` / `6a90ad0573`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `9ms` | `14ms` | `164MB` | `169MB` | ok: gateway RPC |
| Control UI | `109ms` | `332ms` | `491MB` | `989MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-23T02:51:19.916Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.3` | - | - | `1,126MB` | `1,126MB` | failed |
| `2026.7.2-beta.2` | - | - | `1,071MB` | `1,071MB` | failed |
...
| `2026.6.9` | - | - | `665MB` | `665MB` | failed |
| `2026.6.9-beta.1` | - | - | `655MB` | `655MB` | failed |
