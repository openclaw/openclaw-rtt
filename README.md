...
Latest imported channel run: `2026-09-12T12:48:09.525Z` · latest `2026.9.4` / `bcd05342c0`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,003ms` | `2,002ms` | `87MB` | `87MB` | ok |
| Discord | `2,443ms` | `2,664ms` | `1,050MB` | `1,058MB` | ok |
| Slack | `3,314ms` | `3,427ms` | `903MB` | `924MB` | ok |
...
Latest imported surface run: `2026-09-12T12:39:06.091Z` · latest `2026.9.4` / `bcd05342c0`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `92MB` | `110MB` | ok: gateway RPC |
| Control UI | `147ms` | `300ms` | `511MB` | `1,042MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-12T11:01:43.314Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,345MB` | `5,345MB` | failed |
| `2026.9.3` | - | - | `5,505MB` | `5,505MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,339MB` | `5,339MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,416MB` | `5,416MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,433MB` | `5,433MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,272MB` | `5,272MB` | failed: QA command exited with status 1 after producing a missing summary. |
