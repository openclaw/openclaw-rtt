...
Latest imported release coverage run: `2026-09-13T11:30:43.926Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,457MB` | `5,457MB` | failed |
| `2026.9.3` | - | - | `5,494MB` | `5,494MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,323MB` | `5,323MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,425MB` | `5,425MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,496MB` | `5,496MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,444MB` | `5,444MB` | failed: QA command exited with status 1 after producing a missing summary. |
