...
Latest imported channel run: `2026-09-12T19:09:33.081Z` · latest `2026.9.4` / `ffa6f5f305`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,003ms` | `2,002ms` | `87MB` | `87MB` | ok |
| Discord | `1,975ms` | `2,449ms` | `1,037MB` | `1,049MB` | ok |
| Slack | `3,303ms` | `3,375ms` | `919MB` | `933MB` | ok |
...
Latest imported surface run: `2026-09-12T18:34:01.007Z` · latest `2026.9.4` / `f7242760e1`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `93MB` | `111MB` | ok: gateway RPC |
| Control UI | `140ms` | `223ms` | `517MB` | `1,072MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-12T23:07:50.948Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,467MB` | `5,467MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,435MB` | `5,435MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,407MB` | `5,407MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,414MB` | `5,414MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,470MB` | `5,470MB` | failed: QA command exited with status 1 after producing a missing summary. |
