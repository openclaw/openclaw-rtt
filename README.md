...
Latest imported channel run: `2026-08-07T01:27:30.029Z` · latest `2026.7.2` / `9094e10c11`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,034ms` | `2,031ms` | `140MB` | `140MB` | ok |
| Discord | `2,508ms` | `2,851ms` | `3,146MB` | `3,212MB` | ok |
| Slack | `4,137ms` | `4,137ms` | `3,232MB` | `3,232MB` | ok |
...
Latest imported surface run: `2026-08-07T01:37:39.217Z` · latest `2026.7.2` / `01281ad9f8`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `3ms` | `176MB` | `202MB` | ok: gateway RPC |
| Control UI | `160ms` | `370ms` | `495MB` | `1,152MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-08-07T00:00:49.957Z`
...
| `2026.7.2-beta.3` | - | - | `1,204MB` | `1,204MB` | failed |
| `2026.7.2-beta.2` | - | - | `1,228MB` | `1,228MB` | failed |
