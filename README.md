...
Latest imported channel run: `2026-09-26T13:26:26.466Z` · latest `2026.9.6` / `380a77a86f`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,001ms` | `2,007ms` | `87MB` | `87MB` | ok |
| Discord | `5,223ms` | `5,712ms` | `1,307MB` | `1,339MB` | ok |
| Slack | `4,664ms` | `4,767ms` | `1,176MB` | `1,219MB` | ok |
...
Latest imported surface run: `2026-09-26T12:43:31.142Z` · latest `2026.9.6` / `5790b128b7`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `2ms` | `3ms` | `91MB` | `112MB` | ok: gateway RPC |
| Control UI | `218ms` | `258ms` | `521MB` | `962MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-26T17:32:11.744Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.6` | - | - | `5,494MB` | `5,494MB` | failed |
| `2026.9.5` | - | - | `5,472MB` | `5,472MB` | failed |
| `2026.9.4` | - | - | `5,510MB` | `5,510MB` | failed |
| `2026.9.3` | - | - | `5,404MB` | `5,404MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,408MB` | `5,408MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,403MB` | `5,403MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,532MB` | `5,532MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,419MB` | `5,419MB` | failed: QA command exited with status 1 after producing a missing summary. |
