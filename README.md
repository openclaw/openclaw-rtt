...
Latest imported channel run: `2026-07-03T13:13:13.374Z` · latest `2026.6.11` / `153fed790a`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `2,210ms` | `2,561ms` | `1,245MB` | `1,274MB` | ok |
...
Latest imported surface run: `2026-07-03T13:08:19.365Z` · latest `2026.6.11` / `153fed790a`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `4ms` | `7ms` | `182MB` | `185MB` | ok: gateway RPC |
| Control UI | `407ms` | `415ms` | `447MB` | `940MB` | ok: browser/Gateway |
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `801MB` | `803MB` | timeout |
| `2026.5.16-beta.5` | - | - | `800MB` | `818MB` | timeout |
