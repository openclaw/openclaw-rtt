...
Latest imported channel run: `2026-07-22T19:23:51.116Z` · latest `2026.7.2` / `31ff00fe82`
...
| Slack | `3,337ms` | `3,337ms` | `800MB` | `800MB` | stale: latest failed; showing last pass (failed: QA command exited with status 1 before writing a summary.) |
...
Latest imported surface run: `2026-07-22T18:51:19.035Z` · latest `2026.7.2` / `5419a94587`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `18ms` | `32ms` | `164MB` | `168MB` | ok: gateway RPC |
| Control UI | `141ms` | `391ms` | `492MB` | `1,026MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-22T15:33:50.631Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.3` | - | - | `1,264MB` | `1,264MB` | failed |
| `2026.7.2-beta.2` | - | - | `1,217MB` | `1,217MB` | failed |
...
| `2026.6.9` | - | - | `650MB` | `650MB` | failed |
| `2026.6.9-beta.1` | - | - | `668MB` | `668MB` | failed |
| `2026.6.8` | - | - | `629MB` | `629MB` | failed |
