...
Latest imported channel run: `2026-09-02T01:26:29.331Z` · latest `2026.8.1` / `51b0b03802`
...
Latest imported surface run: `2026-09-02T06:52:17.739Z` · latest `2026.8.1` / `944732971b`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `3ms` | `90MB` | `110MB` | ok: gateway RPC |
| Control UI | `228ms` | `386ms` | `509MB` | `1,027MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-02T01:06:52.650Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.9.1-beta.1` | `333ms` | `999ms` | - | fail | fail | - | `334ms` |
| `2026.8.2` | - | `1,002ms` | - | fail | fail | - | - |
...
Latest imported surface run: `2026-09-01T18:45:59.773Z`
