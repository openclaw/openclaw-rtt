...
Latest imported channel run: `2026-06-21T08:21:28.073Z` · latest `2026.6.9` / `c9758bf2a0`
...
Latest imported surface run: `2026-06-21T13:12:11.326Z` · latest `2026.6.9` / `5693fcda78`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `5ms` | `13ms` | `175MB` | `184MB` | ok: gateway RPC |
| Control UI | `406ms` | `417ms` | `454MB` | `1,090MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-21T13:18:10.615Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.6.10-beta.1` | `772ms` | `1,955ms` | - | - | - | - | `411ms` |
...
Latest imported surface run: `2026-06-21T13:18:10.615Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.6.10-beta.1` | - | - | - | - | missing: no imported run |
