...
Latest imported channel run: `2026-07-12T07:49:55.979Z` · latest `2026.7.2` / `cf33f5aa02`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `2,079ms` | `2,356ms` | `1,022MB` | `1,136MB` | ok |
| Slack | `3,302ms` | `3,302ms` | `867MB` | `867MB` | ok |
...
Latest imported surface run: `2026-07-12T07:23:40.261Z` · latest `2026.7.2` / `ba9a04580b`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `4ms` | `6ms` | `174MB` | `183MB` | ok: gateway RPC |
| Control UI | `289ms` | `303ms` | `475MB` | `1,103MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-12T07:43:41.263Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `1,016MB` | `1,022MB` | timeout |
| `2026.5.16-beta.5` | - | - | `1,019MB` | `1,024MB` | timeout |
