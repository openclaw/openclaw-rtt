...
Latest imported channel run: `2026-06-17T08:39:24.980Z` · latest `2026.6.8` / `745b011632`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `2,002ms` | `2,231ms` | `926MB` | `939MB` | ok |
| Slack | `3,153ms` | `4,512ms` | `982MB` | `991MB` | stale: latest failed; showing last pass (failed: QA command exited with status 0 before writing a summary.) |
| WhatsApp | `3,143ms` | `3,638ms` | `1,049MB` | `1,055MB` | stale: latest failed; showing last pass (failed: QA command exited with status 0 before writing a summary.) |
...
Latest imported surface run: `2026-06-17T08:18:28.196Z` · latest `2026.6.8` / `e99a6d4c19`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `4ms` | `13ms` | `174MB` | `183MB` | ok: gateway RPC |
| Control UI | `409ms` | `418ms` | `449MB` | `1,097MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-16T20:14:25.833Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.6.8` | - | - | - | fail | fail | - | `417ms` |
| `2026.6.8-beta.2` | - | - | - | fail | fail | - | `354ms` |
| `2026.6.8-beta.1` | - | - | - | fail | fail | - | `349ms` |
...
Latest imported surface run: `2026-06-16T19:49:36.059Z`
...
| `2026.6.8-beta.1` | - | - | `639MB` | `639MB` | failed: QA command exited with status 0 before writing a summary. |
| `2026.6.7-beta.1` | - | - | `623MB` | `623MB` | failed: QA command exited with status 0 before writing a summary. |
| `2026.6.6` | - | - | `618MB` | `618MB` | failed: details redacted (OPENCLAW_QA_REDACT_PUBLIC_METADATA=1) |
| `2026.6.6-beta.2` | - | - | `616MB` | `616MB` | failed: details redacted (OPENCLAW_QA_REDACT_PUBLIC_METADATA=1) |
