...
Latest imported channel run: `2026-07-12T19:18:37.489Z` · latest `2026.7.2` / `8a595dafe4`
...
| Slack | `3,528ms` | `3,528ms` | `835MB` | `835MB` | ok |
...
Latest imported release coverage run: `2026-07-12T19:15:37.488Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `1,041MB` | `1,045MB` | timeout |
| `2026.5.16-beta.5` | - | - | `1,020MB` | `1,066MB` | timeout |
