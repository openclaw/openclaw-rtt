...
Latest imported channel run: `2026-07-04T19:18:07.541Z` · latest `2026.6.11` / `d102715bb2`
...
Latest imported surface run: `2026-07-04T18:46:59.784Z` · latest `2026.6.11` / `5304d006e5`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `4ms` | `17ms` | `174MB` | `183MB` | ok: gateway RPC |
| Control UI | `405ms` | `413ms` | `449MB` | `931MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-04T19:48:21.629Z`
...
| `2026.6.8-beta.1` | - | - | `592MB` | `592MB` | failed |
| `2026.6.7-beta.1` | - | - | `591MB` | `591MB` | failed |
| `2026.6.6` | - | - | `590MB` | `590MB` | failed: QA command exited with status 0 before writing a summary. |
| `2026.6.6-beta.2` | - | - | `597MB` | `597MB` | failed: QA command exited with status 0 before writing a summary. |
