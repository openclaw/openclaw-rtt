...
Latest imported channel run: `2026-07-03T01:38:24.217Z` · latest `2026.6.11` / `381b44a9fc`
...
| Slack | `3,172ms` | `3,172ms` | `1,024MB` | `1,024MB` | ok |
...
Latest imported release coverage run: `2026-07-03T02:10:58.653Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `786MB` | `804MB` | timeout |
| `2026.5.16-beta.5` | - | - | `794MB` | `831MB` | timeout |
...
| `2026.6.8-beta.1` | - | - | `632MB` | `632MB` | failed |
| `2026.6.7-beta.1` | - | - | `620MB` | `620MB` | failed |
| `2026.6.6` | - | - | `621MB` | `621MB` | failed: QA command exited with status 0 before writing a summary. |
| `2026.6.6-beta.2` | - | - | `616MB` | `616MB` | failed: QA command exited with status 0 before writing a summary. |
