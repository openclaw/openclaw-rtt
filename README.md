...
Latest imported channel run: `2026-07-23T19:20:15.562Z` · latest `2026.7.2` / `913a6a83c5`
...
Latest imported surface run: `2026-07-23T18:52:00.342Z` · latest `2026.7.2` / `c453c03979`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `9ms` | `17ms` | `186MB` | `190MB` | ok: gateway RPC |
| Control UI | `118ms` | `137ms` | `496MB` | `1,078MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-23T20:53:31.831Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.3` | - | - | `1,266MB` | `1,266MB` | failed |
