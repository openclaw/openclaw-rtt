...
Latest imported release coverage run: `2026-09-24T18:16:03.561Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.6` | - | - | `5,393MB` | `5,393MB` | failed |
| `2026.9.5` | - | - | `5,303MB` | `5,303MB` | failed |
| `2026.9.4` | - | - | `5,446MB` | `5,446MB` | failed |
| `2026.9.3` | - | - | `5,439MB` | `5,439MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `4,951MB` | `4,951MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,247MB` | `5,247MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,341MB` | `5,341MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,289MB` | `5,289MB` | failed: QA command exited with status 1 after producing a missing summary. |
