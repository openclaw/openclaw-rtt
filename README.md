...
Latest imported channel run: `2026-07-12T01:06:48.990Z` · latest `2026.7.2` / `3fe61030be`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `2,004ms` | `2,215ms` | `1,114MB` | `1,122MB` | ok |
| Slack | `6,477ms` | `6,477ms` | `982MB` | `982MB` | ok |
...
Latest imported surface run: `2026-07-12T01:03:01.525Z` · latest `2026.7.2` / `4bbca30990`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `6ms` | `19ms` | `174MB` | `183MB` | ok: gateway RPC |
| Control UI | `353ms` | `375ms` | `459MB` | `1,012MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-11T19:50:29.527Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.7.1-beta.5` | `1,945ms` | - | `1,776ms` | `4,778ms` | - | `4,778ms` | `288ms` |
| `2026.7.1-beta.4` | `1,286ms` | - | `1,787ms` | `3,378ms` | - | `3,378ms` | `284ms` |
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `975MB` | `980MB` | timeout |
| `2026.5.16-beta.5` | - | - | `974MB` | `979MB` | timeout |
