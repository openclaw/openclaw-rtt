...
Latest imported channel run: `2026-07-06T01:28:10.022Z` · latest `2026.6.11` / `08852d2bf7`
...
Latest imported release coverage run: `2026-07-06T02:00:09.570Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.1-beta.2` | - | - | `655MB` | `655MB` | failed |
...
| `2026.6.8-beta.1` | - | - | `593MB` | `593MB` | failed |
| `2026.6.7-beta.1` | - | - | `593MB` | `593MB` | failed |
| `2026.6.6` | - | - | `596MB` | `596MB` | failed: QA command exited with status 0 before writing a summary. |
| `2026.6.6-beta.2` | - | - | `587MB` | `587MB` | failed: QA command exited with status 0 before writing a summary. |
