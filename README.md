...
Latest imported channel run: `2026-06-11T14:25:35.366Z` · latest `2026.6.2` / `777f7409d8`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,050ms` | `2,956ms` | `137MB` | `137MB` | ok |
| Discord | `2,122ms` | `2,341ms` | `929MB` | `961MB` | ok |
| Slack | `3,226ms` | `4,625ms` | `976MB` | `1,008MB` | stale: latest failed; showing last pass (failed: slack account "sut" did not become ready; last status: {"lastError":null,"restartPending":false,"running":true}) |
...
Latest imported surface run: `2026-06-11T13:48:00.238Z` · latest `2026.6.2` / `047785eb30`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `10ms` | `12ms` | `174MB` | `182MB` | ok: gateway RPC |
| Control UI | `313ms` | `441ms` | `448MB` | `1,103MB` | ok: browser/Gateway |
