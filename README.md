...
Latest imported channel run: `2026-05-20T01:25:54.359Z` · latest `2026.5.19` / `6048cd43a5`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 |
|---|---:|---:|---:|---:|
| Telegram | `1,018ms` | `2,445ms` | `134MB` | `134MB` |
| Discord | `7,324ms` | `7,640ms` | `779MB` | `793MB` |
