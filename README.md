...
Latest imported channel run: `2026-09-22T01:18:28.701Z` · latest `2026.9.5` / `1f94a0c799`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,001ms` | `2,007ms` | `87MB` | `87MB` | ok |
| Discord | `3,350ms` | `3,624ms` | `1,236MB` | `1,245MB` | ok |
| Slack | `3,288ms` | `4,468ms` | `1,051MB` | `1,219MB` | ok |
...
Latest imported surface run: `2026-09-22T01:08:48.516Z` · latest `2026.9.5` / `1f94a0c799`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `2ms` | `5ms` | `92MB` | `112MB` | ok: gateway RPC |
| Control UI | `259ms` | `426ms` | `527MB` | `932MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-21T21:32:42.401Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.5` | - | - | `5,169MB` | `5,169MB` | failed |
| `2026.9.4` | - | - | `5,034MB` | `5,034MB` | failed |
| `2026.9.3` | - | - | `5,242MB` | `5,242MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `4,931MB` | `4,931MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,030MB` | `5,030MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,280MB` | `5,280MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,109MB` | `5,109MB` | failed: QA command exited with status 1 after producing a missing summary. |
