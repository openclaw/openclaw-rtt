...
Latest imported surface run: `2026-09-16T12:45:49.081Z` · latest `2026.9.4` / `3916acef4c`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `7ms` | `93MB` | `113MB` | ok: gateway RPC |
| Control UI | `347ms` | `420ms` | `521MB` | `1,008MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-16T11:31:20.334Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,014MB` | `5,014MB` | failed |
| `2026.9.3` | - | - | `5,230MB` | `5,230MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,249MB` | `5,249MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,485MB` | `5,485MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,348MB` | `5,348MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `4,918MB` | `4,918MB` | failed: QA command exited with status 1 after producing a missing summary. |
