...
Latest imported channel run: `2026-09-11T18:30:34.994Z` · latest `2026.9.4` / `ebb7cb266f`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,003ms` | `2,012ms` | `86MB` | `86MB` | ok |
| Discord | `2,352ms` | `3,123ms` | `661MB` | `732MB` | ok |
| Slack | `2,928ms` | `3,250ms` | `654MB` | `670MB` | ok |
...
Latest imported surface run: `2026-09-11T12:43:56.525Z` · latest `2026.9.4` / `4407ed19ac`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `3ms` | `92MB` | `113MB` | ok: gateway RPC |
| Control UI | `226ms` | `337ms` | `511MB` | `1,003MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-11T17:36:19.594Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,405MB` | `5,405MB` | failed |
| `2026.9.3` | - | - | `5,209MB` | `5,209MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,360MB` | `5,360MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,307MB` | `5,307MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `4,940MB` | `4,940MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,386MB` | `5,386MB` | failed: QA command exited with status 1 after producing a missing summary. |
