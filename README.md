...
Latest imported release coverage run: `2026-09-21T05:31:14.941Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.5` | - | - | `5,471MB` | `5,471MB` | failed |
| `2026.9.4` | - | - | `5,267MB` | `5,267MB` | failed |
| `2026.9.3` | - | - | `5,351MB` | `5,351MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,325MB` | `5,325MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,366MB` | `5,366MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,293MB` | `5,293MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,315MB` | `5,315MB` | failed: QA command exited with status 1 after producing a missing summary. |
