...
Latest imported surface run: `2026-09-17T06:52:05.164Z` · latest `2026.9.4` / `5d8ac5b8c1`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `3ms` | `91MB` | `110MB` | ok: gateway RPC |
| Control UI | `292ms` | `354ms` | `542MB` | `1,135MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-17T05:31:07.758Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,465MB` | `5,465MB` | failed |
| `2026.9.3` | - | - | `5,380MB` | `5,380MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,005MB` | `5,005MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,191MB` | `5,191MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `4,997MB` | `4,997MB` | failed: QA command exited with status 1 after producing a missing summary. |
