...
Latest imported channel run: `2026-06-23T19:18:00.447Z` · latest `2026.6.9` / `6343e1483f`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,709ms` | `1,806ms` | `1,206MB` | `1,234MB` | ok |
| Slack | `3,017ms` | `3,017ms` | `1,053MB` | `1,053MB` | ok |
...
Latest imported surface run: `2026-06-23T13:26:20.948Z` · latest `2026.6.9` / `3f2b205dde`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `12ms` | `19ms` | `181MB` | `184MB` | ok: gateway RPC |
| Control UI | `408ms` | `428ms` | `447MB` | `940MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-23T14:25:22.351Z`
...
Latest imported surface run: `2026-06-22T20:28:28.294Z`
