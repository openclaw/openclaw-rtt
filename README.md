...
Latest imported channel run: `2026-06-28T08:19:48.909Z` · latest `2026.6.10` / `9c95abd49d`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,888ms` | `2,203ms` | `1,191MB` | `1,238MB` | ok |
| Slack | `3,230ms` | `3,230ms` | `1,068MB` | `1,068MB` | ok |
...
Latest imported surface run: `2026-06-28T13:10:51.948Z` · latest `2026.6.10` / `08d15ec32d`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `4ms` | `12ms` | `183MB` | `187MB` | ok: gateway RPC |
| Control UI | `407ms` | `417ms` | `453MB` | `948MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-28T08:41:49.327Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `780MB` | `814MB` | timeout |
| `2026.5.16-beta.5` | - | - | `782MB` | `799MB` | timeout |
...
| `2026.6.6` | - | - | `617MB` | `617MB` | failed: QA command exited with status 0 before writing a summary. |
| `2026.6.6-beta.2` | - | - | `610MB` | `610MB` | failed: QA command exited with status 0 before writing a summary. |
