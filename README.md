...
Latest imported channel run: `2026-08-01T02:24:23.869Z` · latest `2026.7.2` / `1e0f62ebfe`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,016ms` | `2,020ms` | `150MB` | `150MB` | ok |
| Discord | `3,119ms` | `3,303ms` | `3,129MB` | `3,159MB` | ok |
| Slack | `4,830ms` | `4,830ms` | `3,146MB` | `3,146MB` | ok |
...
Latest imported release coverage run: `2026-08-01T02:50:53.276Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.7.2-beta.5` | `1,708ms` | `1,031ms` | `4,211ms` | fail | fail | `0ms` | `102ms` |
| `2026.7.2-beta.4` | `802ms` | `1,024ms` | `1,988ms` | fail | fail | `0ms` | `113ms` |
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.5` | `4,211ms` | `4,521ms` | `3,147MB` | `3,183MB` | ok |
| `2026.7.2-beta.4` | `1,988ms` | `2,166ms` | `3,148MB` | `3,181MB` | ok |
...
| `2026.5.18-beta.1` | - | - | `718MB` | `718MB` | failed: QA command exited with status 0 before writing a summary. |
