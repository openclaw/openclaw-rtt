...
Latest imported channel run: `2026-08-05T13:10:31.705Z` · latest `2026.7.2` / `74014c286d`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,018ms` | `2,117ms` | `149MB` | `149MB` | ok |
| Discord | `3,075ms` | `3,615ms` | `3,152MB` | `3,212MB` | ok |
...
Latest imported release coverage run: `2026-08-05T09:39:23.790Z`
...
| `2026.5.16-beta.5` | `4,703ms` | `4,791ms` | `765MB` | `765MB` | failed: QA command exited with status 0 before writing a summary. |
...
| `2026.6.6-beta.2` | - | - | `647MB` | `647MB` | failed: QA command exited with status 0 before writing a summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `657MB` | `657MB` | failed: QA command exited with status 0 before writing a summary. |
