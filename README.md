...
Latest imported channel run: `2026-08-07T13:25:47.824Z` · latest `2026.7.2` / `01cc71060d`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,034ms` | `2,031ms` | `140MB` | `140MB` | ok |
| Discord | `3,341ms` | `3,784ms` | `3,159MB` | `3,199MB` | ok |
...
Latest imported surface run: `2026-08-07T12:46:19.331Z` · latest `2026.7.2` / `01cc71060d`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `2ms` | `177MB` | `203MB` | ok: gateway RPC |
| Control UI | `373ms` | `406ms` | `481MB` | `1,156MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-08-07T08:57:20.179Z`
...
| `2026.7.2-beta.3` | - | - | `1,210MB` | `1,210MB` | failed |
| `2026.7.2-beta.2` | - | - | `1,243MB` | `1,243MB` | failed |
