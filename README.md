...
Latest imported channel run: `2026-06-25T01:48:14.111Z` · latest `2026.6.10` / `a21144d8a6`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,868ms` | `2,087ms` | `1,190MB` | `1,232MB` | ok |
| Slack | `3,372ms` | `3,372ms` | `1,053MB` | `1,053MB` | ok |
...
Latest imported surface run: `2026-06-25T01:25:11.411Z` · latest `2026.6.10` / `a21144d8a6`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `6ms` | `13ms` | `174MB` | `183MB` | ok: gateway RPC |
| Control UI | `323ms` | `347ms` | `452MB` | `881MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-25T02:14:57.829Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.6.11-beta.1` | `1,119ms` | `1,850ms` | - | `3,120ms` | - | `3,120ms` | `407ms` |
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `777MB` | `785MB` | timeout |
| `2026.5.16-beta.5` | - | - | `780MB` | `796MB` | timeout |
...
| `2026.6.7-beta.1` | - | - | `636MB` | `636MB` | failed |
