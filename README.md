...
Latest imported channel run: `2026-09-16T19:16:12.059Z` · latest `2026.9.4` / `5c5a51060d`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,001ms` | `2,007ms` | `87MB` | `87MB` | ok |
| Discord | `2,223ms` | `2,613ms` | `1,090MB` | `1,160MB` | stale: latest failed; showing last pass (failed: This operation was aborted) |
| Slack | `2,918ms` | `3,352ms` | `1,004MB` | `1,113MB` | ok |
...
Latest imported surface run: `2026-09-16T18:39:11.925Z` · latest `2026.9.4` / `1e19298f99`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `2ms` | `4ms` | `94MB` | `110MB` | ok: gateway RPC |
| Control UI | `285ms` | `321ms` | `540MB` | `1,107MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-16T23:28:14.507Z`
...
Latest imported surface run: `2026-09-11T06:56:32.698Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,293MB` | `5,293MB` | failed |
| `2026.9.3` | - | - | `5,476MB` | `5,476MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,268MB` | `5,268MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,256MB` | `5,256MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,334MB` | `5,334MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,324MB` | `5,324MB` | failed: QA command exited with status 1 after producing a missing summary. |
