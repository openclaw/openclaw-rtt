...
Latest imported channel run: `2026-09-04T01:39:44.498Z` · latest `2026.8.1` / `75130176b9`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `998ms` | `2,005ms` | `87MB` | `87MB` | ok |
| Discord | `1,445ms` | `1,582ms` | `762MB` | `771MB` | ok |
| Slack | `3,323ms` | `3,506ms` | `752MB` | `762MB` | ok |
...
Latest imported surface run: `2026-09-04T01:04:58.734Z` · latest `2026.8.1` / `3d30b3accb`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `2ms` | `92MB` | `110MB` | ok: gateway RPC |
| Control UI | `187ms` | `279ms` | `500MB` | `1,013MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-04T02:17:28.715Z`
...
| `2026.7.2-beta.2` | `1,724ms` | `1,018ms` | `2,042ms` | `4,783ms` | fail | `5ms` | `314ms` |
...
| `2026.7.2-beta.2` | `4,783ms` | `4,783ms` | `5,062MB` | `5,062MB` | ok |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,187MB` | `5,187MB` | failed: QA command exited with status 1 after producing a missing summary. |
