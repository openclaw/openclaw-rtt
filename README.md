...
Latest imported channel run: `2026-09-12T06:34:20.652Z` · latest `2026.9.4` / `27e810cf26`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,003ms` | `2,002ms` | `87MB` | `87MB` | ok |
| Discord | `2,308ms` | `2,733ms` | `772MB` | `784MB` | ok |
| Slack | `3,282ms` | `3,313ms` | `666MB` | `680MB` | ok |
...
Latest imported surface run: `2026-09-12T01:03:38.043Z` · latest `2026.9.4` / `3ccc3710bd`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `2ms` | `93MB` | `111MB` | ok: gateway RPC |
| Control UI | `149ms` | `213ms` | `511MB` | `1,051MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-12T05:17:29.090Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,448MB` | `5,448MB` | failed |
| `2026.9.3` | - | - | `5,281MB` | `5,281MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,419MB` | `5,419MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,452MB` | `5,452MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,370MB` | `5,370MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,220MB` | `5,220MB` | failed: QA command exited with status 1 after producing a missing summary. |
