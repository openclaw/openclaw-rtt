...
Latest imported channel run: `2026-09-13T07:14:11.261Z` · latest `2026.9.4` / `908e90a462`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,003ms` | `2,002ms` | `87MB` | `87MB` | ok |
| Discord | `1,763ms` | `2,042ms` | `995MB` | `1,004MB` | ok |
| Slack | `3,320ms` | `3,467ms` | `850MB` | `880MB` | ok |
...
Latest imported surface run: `2026-09-13T06:48:29.216Z` · latest `2026.9.4` / `0f74803633`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `93MB` | `111MB` | ok: gateway RPC |
| Control UI | `163ms` | `239ms` | `524MB` | `1,056MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-13T05:18:21.470Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,561MB` | `5,561MB` | failed |
| `2026.9.3` | - | - | `5,291MB` | `5,291MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,399MB` | `5,399MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,469MB` | `5,469MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,442MB` | `5,442MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,427MB` | `5,427MB` | failed: QA command exited with status 1 after producing a missing summary. |
