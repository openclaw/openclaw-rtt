...
Latest imported channel run: `2026-06-14T13:21:22.646Z` · latest `2026.6.2` / `fbc3fa3876`
...
Latest imported surface run: `2026-06-14T18:54:39.139Z` · latest `2026.6.2` / `a189baa4b3`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `10ms` | `13ms` | `181MB` | `183MB` | ok: gateway RPC |
| Control UI | `400ms` | `412ms` | `450MB` | `1,092MB` | ok: browser/Gateway |
