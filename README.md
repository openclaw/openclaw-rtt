...
Latest imported channel run: `2026-09-10T07:17:36.829Z` · latest `2026.9.3` / `5a7eb75732`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,002ms` | `2,002ms` | `86MB` | `86MB` | ok |
| Discord | `2,080ms` | `2,290ms` | `748MB` | `780MB` | ok |
| Slack | `2,916ms` | `3,012ms` | `692MB` | `701MB` | ok |
...
Latest imported surface run: `2026-09-10T06:50:37.654Z` · latest `2026.9.3` / `61ae3f1b0a`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `2ms` | `90MB` | `112MB` | ok: gateway RPC |
| Control UI | `239ms` | `427ms` | `509MB` | `1,018MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-10T09:40:31.263Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.3` | - | - | `5,428MB` | `5,428MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,300MB` | `5,300MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,466MB` | `5,466MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,394MB` | `5,394MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,453MB` | `5,453MB` | failed: QA command exited with status 1 after producing a missing summary. |
