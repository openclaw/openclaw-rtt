...
Latest imported channel run: `2026-09-11T06:35:15.423Z` · latest `2026.9.3` / `bc21739e1d`
...
Latest imported surface run: `2026-09-11T06:47:50.996Z` · latest `2026.9.3` / `969840671a`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `2ms` | `93MB` | `112MB` | ok: gateway RPC |
| Control UI | `198ms` | `376ms` | `510MB` | `1,020MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-11T06:56:32.698Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.9.4` | `441ms` | `1,000ms` | - | fail | fail | `1ms` | `145ms` |
