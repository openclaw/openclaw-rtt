...
Latest imported channel run: `2026-09-10T19:12:30.759Z` · latest `2026.9.3` / `a0a3bd0b63`
...
Latest imported release coverage run: `2026-09-10T17:16:18.300Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.3` | - | - | `5,445MB` | `5,445MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `4,933MB` | `4,933MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,373MB` | `5,373MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `4,863MB` | `4,863MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,085MB` | `5,085MB` | failed: QA command exited with status 1 after producing a missing summary. |
