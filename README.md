...
Latest imported channel run: `2026-06-27T13:20:36.938Z` · latest `2026.6.10` / `c5d34c8376`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,777ms` | `1,990ms` | `1,193MB` | `1,226MB` | ok |
| Slack | `3,255ms` | `3,255ms` | `1,052MB` | `1,052MB` | ok |
...
Latest imported surface run: `2026-06-27T12:55:27.770Z` · latest `2026.6.10` / `c5d34c8376`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `5ms` | `11ms` | `179MB` | `184MB` | ok: gateway RPC |
| Control UI | `410ms` | `415ms` | `447MB` | `902MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-27T13:54:10.408Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `781MB` | `803MB` | timeout |
| `2026.5.16-beta.5` | - | - | `784MB` | `797MB` | timeout |
