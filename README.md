...
Latest imported channel run: `2026-08-03T00:52:56.988Z` · latest `2026.7.2` / `18c9f27e2d`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,010ms` | `2,045ms` | `149MB` | `149MB` | ok |
...
Latest imported release coverage run: `2026-08-02T20:45:50.624Z`
...
| `2026.6.6` | - | - | `656MB` | `656MB` | failed: QA command exited with status 0 before writing a summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `610MB` | `610MB` | failed: QA command exited with status 0 before writing a summary. |
