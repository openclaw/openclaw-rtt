...
Latest imported channel run: `2026-05-21T07:30:12.565Z` · latest `2026.5.20` / `3cc8b2a3d0`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 |
|---|---:|---:|---:|---:|
| Telegram | `1,324ms` | `2,264ms` | `134MB` | `134MB` |
| Discord | `7,502ms` | `7,953ms` | `783MB` | `796MB` |
| Slack | `4,222ms` | `5,517ms` | `687MB` | `743MB` |
| WhatsApp | `7,733ms` | `10,044ms` | `1,104MB` | `1,572MB` |
...
|---|---:|---:|---:|---:|---:|
| `2026.5.20-beta.1` | `2,461ms` | `1,054ms` | `7,047ms` | `4,609ms` | - |
| `2026.5.19` | `2,262ms` | `1,444ms` | `6,951ms` | `4,727ms` | - |
| `2026.5.19-beta.2` | `2,562ms` | `1,036ms` | `7,279ms` | `4,713ms` | - |
| `2026.5.19-beta.1` | `1,710ms` | `1,224ms` | `5,092ms` | `4,551ms` | - |
| `2026.5.18` | `2,555ms` | `1,061ms` | `7,318ms` | `4,253ms` | - |
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 |
|---|---:|---:|---:|---:|
| `2026.5.20-beta.1` | `7,047ms` | `7,412ms` | `749MB` | `766MB` |
| `2026.5.19` | `6,951ms` | `7,238ms` | `746MB` | `778MB` |
| `2026.5.19-beta.2` | `7,279ms` | `7,506ms` | `745MB` | `789MB` |
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 |
|---|---:|---:|---:|---:|
| `2026.5.20-beta.1` | `4,609ms` | `6,020ms` | `706MB` | `768MB` |
| `2026.5.19` | `4,727ms` | `6,190ms` | `711MB` | `747MB` |
| `2026.5.19-beta.2` | `4,713ms` | `5,988ms` | `713MB` | `751MB` |
| `2026.5.19-beta.1` | `4,551ms` | `5,896ms` | `718MB` | `754MB` |
| `2026.5.18` | `4,253ms` | `5,549ms` | `710MB` | `767MB` |
| `2026.5.18-beta.1` | - | - | `569MB` | `569MB` |
...
| `2026.5.18` | - | - | `647MB` | `647MB` |
| `2026.5.18-beta.1` | - | - | `604MB` | `604MB` |
