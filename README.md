...
Latest imported channel run: `2026-09-17T19:18:04.163Z` · latest `2026.9.4` / `f6d8e23461`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,001ms` | `2,007ms` | `87MB` | `87MB` | ok |
| Discord | `1,674ms` | `2,186ms` | `1,018MB` | `1,024MB` | ok |
| Slack | `2,987ms` | `3,332ms` | `981MB` | `1,002MB` | ok |
...
Latest imported surface run: `2026-09-17T18:40:31.393Z` · latest `2026.9.4` / `ecc4c992fb`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `93MB` | `111MB` | ok: gateway RPC |
| Control UI | `311ms` | `415ms` | `539MB` | `1,123MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-17T17:27:08.765Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,295MB` | `5,295MB` | failed |
| `2026.9.3` | - | - | `5,198MB` | `5,198MB` | failed |
...
| `2026.6.6` | - | - | `5,200MB` | `5,200MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,383MB` | `5,383MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,432MB` | `5,432MB` | failed: QA command exited with status 1 after producing a missing summary. |
