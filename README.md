...
Latest imported channel run: `2026-09-23T07:31:08.994Z` · latest `2026.9.5` / `3ab93b4ea5`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,001ms` | `2,007ms` | `87MB` | `87MB` | ok |
| Discord | `3,625ms` | `3,871ms` | `1,366MB` | `1,386MB` | ok |
| Slack | `2,813ms` | `4,055ms` | `1,203MB` | `1,304MB` | ok |
...
Latest imported surface run: `2026-09-23T06:52:02.624Z` · latest `2026.9.5` / `2e9a2eceb1`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `4ms` | `93MB` | `113MB` | ok: gateway RPC |
| Control UI | `178ms` | `246ms` | `524MB` | `969MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-23T05:43:21.583Z`
...
| `2026.7.2-beta.5` | `1,644ms` | `1,031ms` | `3,938ms` | `3,330ms` | fail | `13ms` | `102ms` |
| `2026.7.2-beta.4` | `1,266ms` | `1,024ms` | `2,149ms` | `3,344ms` | fail | `22ms` | `113ms` |
| `2026.7.2-beta.3` | `2,251ms` | `1,024ms` | `5,977ms` | `3,352ms` | fail | `5ms` | `313ms` |
...
| `2026.7.1` | `1,197ms` | `1,022ms` | `1,797ms` | `3,333ms` | fail | `7ms` | `280ms` |
| `2026.7.1-beta.6` | `1,191ms` | `1,024ms` | `1,808ms` | `3,335ms` | fail | `8ms` | `328ms` |
| `2026.7.1-beta.5` | `1,719ms` | `984ms` | `1,776ms` | `4,778ms` | fail | `6ms` | `288ms` |
| `2026.7.1-beta.4` | `1,345ms` | n/a | `1,787ms` | `3,378ms` | fail | `8ms` | `284ms` |
| `2026.7.1-beta.2` | `1,206ms` | `1,992ms` | `1,666ms` | `3,352ms` | fail | `6ms` | `341ms` |
| `2026.7.1-beta.1` | `1,259ms` | `1,903ms` | `1,889ms` | `3,549ms` | fail | `7ms` | `407ms` |
| `2026.6.35` | n/a | - | - | - | fail | - | - |
| `2026.6.34` | `1,182ms` | `1,000ms` | `1,770ms` | `3,348ms` | fail | `7ms` | `400ms` |
| `2026.6.33` | `1,012ms` | `1,029ms` | `1,425ms` | `2,909ms` | fail | `6ms` | `360ms` |
| `2026.6.11` | `1,127ms` | `999ms` | `1,728ms` | `3,213ms` | fail | `20ms` | `413ms` |
| `2026.6.11-beta.2` | `1,120ms` | `988ms` | `1,759ms` | `3,174ms` | fail | `6ms` | `413ms` |
| `2026.6.11-beta.1` | `1,123ms` | `1,850ms` | `1,876ms` | `3,120ms` | fail | `5ms` | `407ms` |
| `2026.6.10` | `1,645ms` | `1,961ms` | `1,790ms` | `4,698ms` | fail | `18ms` | `407ms` |
| `2026.6.10-beta.2` | `1,170ms` | `1,945ms` | `1,795ms` | `3,275ms` | fail | `17ms` | `402ms` |
| `2026.6.10-beta.1` | `1,252ms` | `1,955ms` | `1,971ms` | `3,518ms` | fail | `24ms` | `411ms` |
| `2026.6.9` | `1,208ms` | `1,974ms` | `2,166ms` | `3,301ms` | fail | `14ms` | `403ms` |
| `2026.6.9-beta.1` | `1,205ms` | `1,970ms` | `2,167ms` | `3,293ms` | fail | `17ms` | `405ms` |
| `2026.6.8` | `1,241ms` | `1,984ms` | `2,340ms` | `3,363ms` | fail | `20ms` | `417ms` |
...
| `2026.6.5-beta.5` | `1,144ms` | `1,145ms` | `1,933ms` | `3,130ms` | `2,668ms` | `19ms` | `346ms` |
| `2026.6.5-beta.3` | `1,198ms` | `1,013ms` | `1,892ms` | `3,151ms` | `2,869ms` | `14ms` | `310ms` |
| `2026.6.5-beta.2` | `1,229ms` | `1,013ms` | `1,837ms` | `3,177ms` | `3,029ms` | `7ms` | `333ms` |
| `2026.6.5-beta.1` | `1,221ms` | `1,019ms` | `1,792ms` | `3,192ms` | `3,031ms` | `4ms` | `398ms` |
| `2026.6.2-beta.1` | `1,239ms` | `1,001ms` | `1,737ms` | `3,221ms` | `3,020ms` | `6ms` | `308ms` |
| `2026.6.1` | `1,292ms` | `1,059ms` | `1,862ms` | `3,190ms` | `3,303ms` | `6ms` | `303ms` |
| `2026.6.1-beta.3` | `1,244ms` | `1,089ms` | `1,852ms` | `3,209ms` | `3,147ms` | `6ms` | `401ms` |
| `2026.6.1-beta.2` | `1,165ms` | `988ms` | `1,824ms` | `2,940ms` | `3,072ms` | `7ms` | n/a |
| `2026.6.1-beta.1` | `1,203ms` | `1,009ms` | `1,865ms` | `2,915ms` | `3,267ms` | `9ms` | n/a |
| `2026.5.31-beta.4` | `1,189ms` | `1,139ms` | `1,953ms` | `3,241ms` | `2,957ms` | `7ms` | n/a |
...
Latest imported surface run: `2026-09-19T06:55:22.982Z`
...
| `2026.7.2-beta.5` | `13ms` | `102ms` |
| `2026.7.2-beta.4` | `22ms` | `113ms` |
| `2026.7.2-beta.3` | `5ms` | `313ms` |
| `2026.7.2-beta.2` | `5ms` | `314ms` |
| `2026.7.2-beta.1` | `6ms` | `306ms` |
| `2026.7.1-2` | `4ms` | `281ms` |
| `2026.7.1-1` | `8ms` | `195ms` |
| `2026.7.1` | `7ms` | `280ms` |
| `2026.7.1-beta.6` | `8ms` | `328ms` |
| `2026.7.1-beta.5` | `6ms` | `288ms` |
| `2026.7.1-beta.4` | `8ms` | `284ms` |
| `2026.7.1-beta.2` | `6ms` | `341ms` |
| `2026.7.1-beta.1` | `7ms` | `407ms` |
| `2026.6.35` | - | - |
| `2026.6.34` | `7ms` | `400ms` |
| `2026.6.33` | `6ms` | `360ms` |
| `2026.6.11` | `20ms` | `413ms` |
| `2026.6.11-beta.2` | `6ms` | `413ms` |
| `2026.6.11-beta.1` | `5ms` | `407ms` |
| `2026.6.10` | `18ms` | `407ms` |
| `2026.6.10-beta.2` | `17ms` | `402ms` |
| `2026.6.10-beta.1` | `24ms` | `411ms` |
| `2026.6.9` | `14ms` | `403ms` |
| `2026.6.9-beta.1` | `17ms` | `405ms` |
| `2026.6.8` | `20ms` | `417ms` |
| `2026.6.8-beta.2` | `17ms` | `354ms` |
| `2026.6.8-beta.1` | `20ms` | `349ms` |
| `2026.6.7-beta.1` | `22ms` | `316ms` |
| `2026.6.6` | `16ms` | `307ms` |
| `2026.6.6-beta.2` | `19ms` | `407ms` |
| `2026.6.5` | `10ms` | `308ms` |
| `2026.6.5-beta.6` | `14ms` | `306ms` |
| `2026.6.5-beta.5` | `19ms` | `346ms` |
| `2026.6.5-beta.3` | `14ms` | `310ms` |
| `2026.6.5-beta.2` | `7ms` | `333ms` |
| `2026.6.5-beta.1` | `4ms` | `398ms` |
| `2026.6.2-beta.1` | `6ms` | `308ms` |
| `2026.6.1` | `6ms` | `303ms` |
| `2026.6.1-beta.3` | `6ms` | `401ms` |
| `2026.6.1-beta.2` | `7ms` | n/a |
| `2026.6.1-beta.1` | `9ms` | n/a |
| `2026.5.31-beta.4` | `7ms` | n/a |
...
| `2026.7.35` | - | - | - | - | missing: no imported run |
...
| `2026.6.35` | - | - | - | - | missing: no imported run |
...
| `2026.9.3` | `1,370ms` | `1,809ms` | `5,159MB` | `5,231MB` | ok |
...
| `2026.6.35` | - | - | - | - | missing: no imported run |
| `2026.6.34` | `1,770ms` | `2,237ms` | `5,178MB` | `5,210MB` | ok |
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.5` | - | - | `5,386MB` | `5,386MB` | failed |
| `2026.9.4` | - | - | `5,315MB` | `5,315MB` | failed |
| `2026.9.3` | - | - | `5,324MB` | `5,324MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.7.2-beta.5` | `3,330ms` | `4,825ms` | `5,222MB` | `5,425MB` | ok |
| `2026.7.2-beta.4` | `3,344ms` | `3,461ms` | `5,294MB` | `5,411MB` | ok |
| `2026.7.2-beta.3` | `3,352ms` | `3,393ms` | `5,330MB` | `5,438MB` | ok |
...
| `2026.6.35` | - | - | - | - | missing: no imported run |
| `2026.6.34` | `3,348ms` | `3,348ms` | `5,368MB` | `5,368MB` | ok |
...
| `2026.7.35` | - | - | `4,943MB` | `4,943MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.6.35` | - | - | `5,310MB` | `5,310MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.6.8-beta.2` | - | - | `5,385MB` | `5,385MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,355MB` | `5,355MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,458MB` | `5,458MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,312MB` | `5,312MB` | failed: QA command exited with status 1 after producing a missing summary. |
