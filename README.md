...
Latest imported surface run: `2026-09-10T18:36:33.766Z` · latest `2026.9.3` / `e0b7f1d46e`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `2ms` | `90MB` | `112MB` | ok: gateway RPC |
| Control UI | `209ms` | `314ms` | `511MB` | `1,053MB` | ok: browser/Gateway |
