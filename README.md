...
Latest imported surface run: `2026-09-21T01:12:23.325Z` · latest `2026.9.5` / `052d26eec0`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `90MB` | `110MB` | ok: gateway RPC |
| Control UI | `243ms` | `505ms` | `527MB` | `935MB` | ok: browser/Gateway |
