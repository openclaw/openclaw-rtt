...
Latest imported channel run: `2026-07-08T07:22:50.501Z` · latest `2026.6.11` / `7e0324263b`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,899ms` | `2,275ms` | `1,138MB` | `1,187MB` | ok |
| Slack | `4,704ms` | `4,704ms` | `963MB` | `963MB` | stale: latest failed; showing last pass (failed) |
...
Latest imported surface run: `2026-07-08T07:18:48.262Z` · latest `2026.6.11` / `7e0324263b`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `7ms` | `15ms` | `175MB` | `185MB` | ok: gateway RPC |
| Control UI | `285ms` | `316ms` | `447MB` | `936MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-08T02:03:53.475Z`
...
Latest imported surface run: `2026-07-08T01:53:35.982Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `899MB` | `908MB` | timeout |
| `2026.5.16-beta.5` | - | - | `901MB` | `908MB` | timeout |
...
| `2026.6.7-beta.1` | - | - | `620MB` | `620MB` | failed |
| `2026.6.6` | - | - | `622MB` | `622MB` | failed: QA command exited with status 0 before writing a summary. |
| `2026.6.6-beta.2` | - | - | `609MB` | `609MB` | failed: QA command exited with status 0 before writing a summary. |
