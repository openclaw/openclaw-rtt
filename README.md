...
Latest imported channel run: `2026-09-19T13:08:16.947Z` · latest `2026.9.5` / `43e41b26ec`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,001ms` | `2,007ms` | `87MB` | `87MB` | ok |
| Discord | `1,741ms` | `2,041ms` | `1,095MB` | `1,104MB` | ok |
| Slack | `3,302ms` | `3,385ms` | `977MB` | `984MB` | ok |
...
Latest imported surface run: `2026-09-19T18:35:14.522Z` · latest `2026.9.5` / `fda6fb3016`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `90MB` | `109MB` | ok: gateway RPC |
| Control UI | `204ms` | `262ms` | `526MB` | `1,099MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-19T17:12:59.223Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.5` | - | - | `5,463MB` | `5,463MB` | failed |
| `2026.9.4` | - | - | `5,341MB` | `5,341MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,482MB` | `5,482MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,475MB` | `5,475MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,462MB` | `5,462MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,367MB` | `5,367MB` | failed: QA command exited with status 1 after producing a missing summary. |
