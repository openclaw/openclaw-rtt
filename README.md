...
Latest imported channel run: `2026-09-16T01:23:38.602Z` · latest `2026.9.4` / `09269058f7`
...
Latest imported release coverage run: `2026-09-15T23:56:07.102Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,269MB` | `5,269MB` | failed |
| `2026.9.3` | - | - | `5,316MB` | `5,316MB` | failed |
...
| `2026.6.6-beta.2` | - | - | `5,455MB` | `5,455MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,232MB` | `5,232MB` | failed: QA command exited with status 1 after producing a missing summary. |
