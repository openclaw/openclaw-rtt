...
Latest imported surface run: `2026-09-26T01:07:05.141Z` · latest `2026.9.6` / `0e926158be`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `2ms` | `4ms` | `91MB` | `109MB` | ok: gateway RPC |
| Control UI | `209ms` | `615ms` | `525MB` | `1,131MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-25T23:50:46.149Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.6` | - | - | `5,387MB` | `5,387MB` | failed |
| `2026.9.5` | - | - | `5,389MB` | `5,389MB` | failed |
| `2026.9.4` | - | - | `5,296MB` | `5,296MB` | failed |
| `2026.9.3` | - | - | `5,511MB` | `5,511MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,243MB` | `5,243MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,455MB` | `5,455MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,418MB` | `5,418MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,267MB` | `5,267MB` | failed: QA command exited with status 1 after producing a missing summary. |
