...
Latest imported channel run: `2026-07-31T07:58:32.846Z` · latest `2026.7.2` / `37b1a71654`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,028ms` | `2,143ms` | `149MB` | `149MB` | ok |
| Discord | `3,090ms` | `3,297ms` | `3,158MB` | `3,185MB` | ok |
| Slack | `4,150ms` | `4,150ms` | `3,246MB` | `3,246MB` | ok |
...
Latest imported surface run: `2026-07-31T07:27:11.947Z` · latest `2026.7.2` / `a8df6e49a7`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `0ms` | `1ms` | `189MB` | `194MB` | ok: gateway RPC |
| Control UI | `209ms` | `357ms` | `488MB` | `1,168MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-31T09:19:20.402Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.7.2-beta.5` | `3,845ms` | `1,031ms` | `9,209ms` | fail | fail | `0ms` | `102ms` |
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.5` | `9,209ms` | `9,209ms` | `3,141MB` | `3,141MB` | ok |
| `2026.7.2-beta.4` | `2,125ms` | `2,125ms` | `3,124MB` | `3,124MB` | ok |
