...
Latest imported channel run: `2026-07-03T01:09:20.852Z` · latest `2026.6.11` / `9238d9aeae`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,882ms` | `2,140ms` | `1,192MB` | `1,238MB` | ok |
| Slack | `3,284ms` | `3,284ms` | `1,014MB` | `1,014MB` | ok |
...
Latest imported surface run: `2026-07-03T01:06:51.765Z` · latest `2026.6.11` / `9238d9aeae`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `5ms` | `10ms` | `183MB` | `183MB` | ok: gateway RPC |
| Control UI | `314ms` | `454ms` | `455MB` | `936MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-02T19:53:49.812Z`
...
Latest imported surface run: `2026-07-02T08:35:52.615Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `778MB` | `800MB` | timeout |
| `2026.5.16-beta.5` | - | - | `778MB` | `801MB` | timeout |
...
| `2026.6.7-beta.1` | - | - | `627MB` | `627MB` | failed |
| `2026.6.6` | - | - | `621MB` | `621MB` | failed: QA command exited with status 0 before writing a summary. |
| `2026.6.6-beta.2` | - | - | `618MB` | `618MB` | failed: QA command exited with status 0 before writing a summary. |
