...
Latest imported channel run: `2026-07-07T01:28:28.969Z` · latest `2026.6.11` / `82106a18b3`
...
Latest imported surface run: `2026-07-07T01:08:59.221Z` · latest `2026.6.11` / `bb658d0a6d`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `4ms` | `5ms` | `174MB` | `184MB` | ok: gateway RPC |
| Control UI | `298ms` | `327ms` | `449MB` | `954MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-07T02:00:39.012Z`
...
| `2026.6.8-beta.1` | - | - | `594MB` | `594MB` | failed |
| `2026.6.7-beta.1` | - | - | `582MB` | `582MB` | failed |
| `2026.6.6` | - | - | `594MB` | `594MB` | failed: QA command exited with status 0 before writing a summary. |
| `2026.6.6-beta.2` | - | - | `591MB` | `591MB` | failed: QA command exited with status 0 before writing a summary. |
