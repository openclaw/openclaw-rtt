...
Latest imported channel run: `2026-08-06T07:50:16.606Z` · latest `2026.7.2` / `245dbacbe0`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,028ms` | `2,052ms` | `148MB` | `148MB` | ok |
| Discord | `3,423ms` | `3,664ms` | `3,154MB` | `3,181MB` | ok |
| Slack | `3,070ms` | `3,070ms` | `3,182MB` | `3,182MB` | ok |
...
Latest imported surface run: `2026-08-06T07:26:41.586Z` · latest `2026.7.2` / `ed40d0599b`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `3ms` | `188MB` | `190MB` | ok: gateway RPC |
| Control UI | `155ms` | `339ms` | `497MB` | `1,144MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-08-06T03:21:59.548Z`
...
| `2026.7.2-beta.3` | - | - | `1,094MB` | `1,094MB` | failed |
...
| `2026.5.18-beta.1` | - | - | `704MB` | `704MB` | failed: QA command exited with status 0 before writing a summary. |
...
| `2026.6.8-beta.2` | - | - | `668MB` | `668MB` | failed |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `623MB` | `623MB` | failed: QA command exited with status 0 before writing a summary. |
