...
Latest imported channel run: `2026-09-07T01:30:05.772Z` · latest `2026.9.2` / `98c0918709`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,002ms` | `2,003ms` | `86MB` | `86MB` | ok |
| Discord | `1,474ms` | `1,764ms` | `731MB` | `735MB` | ok |
| Slack | `1,902ms` | `3,323ms` | `676MB` | `683MB` | ok |
...
Latest imported surface run: `2026-09-07T01:10:37.445Z` · latest `2026.9.2` / `6df7c32f47`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `91MB` | `111MB` | ok: gateway RPC |
| Control UI | `144ms` | `234ms` | `511MB` | `1,051MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-06T22:17:02.807Z`
...
| `2026.6.8-beta.2` | - | - | `5,388MB` | `5,388MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,322MB` | `5,322MB` | failed: QA command exited with status 1 after producing a missing summary. |
