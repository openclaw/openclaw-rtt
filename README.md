...
Latest imported channel run: `2026-06-23T08:20:34.146Z` · latest `2026.6.9` / `d63a73a1b8`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,708ms` | `1,833ms` | `1,174MB` | `1,198MB` | ok |
| Slack | `3,292ms` | `3,292ms` | `1,054MB` | `1,054MB` | ok |
...
Latest imported surface run: `2026-06-23T07:57:49.453Z` · latest `2026.6.9` / `2824c02a42`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `10ms` | `22ms` | `174MB` | `184MB` | ok: gateway RPC |
| Control UI | `416ms` | `439ms` | `456MB` | `924MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-23T02:07:32.544Z`
...
| `2026.6.8-beta.1` | - | - | `644MB` | `644MB` | failed |
| `2026.6.7-beta.1` | - | - | `607MB` | `607MB` | failed |
