...
Latest imported channel run: `2026-09-25T01:42:08.108Z` · latest `2026.9.6` / `ef2dd32351`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,001ms` | `2,007ms` | `87MB` | `87MB` | ok |
| Discord | `4,127ms` | `5,710ms` | `1,167MB` | `1,257MB` | ok |
| Slack | `4,077ms` | `4,430ms` | `1,181MB` | `1,195MB` | ok |
...
Latest imported surface run: `2026-09-25T01:08:22.068Z` · latest `2026.9.6` / `229ab8a1fe`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `2ms` | `91MB` | `112MB` | ok: gateway RPC |
| Control UI | `259ms` | `319ms` | `528MB` | `1,037MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-24T23:50:28.994Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.6` | - | - | `5,540MB` | `5,540MB` | failed |
| `2026.9.5` | - | - | `5,437MB` | `5,437MB` | failed |
| `2026.9.4` | - | - | `5,457MB` | `5,457MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.9.3` | - | - | `5,498MB` | `5,498MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,441MB` | `5,441MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,230MB` | `5,230MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,263MB` | `5,263MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,335MB` | `5,335MB` | failed: QA command exited with status 1 after producing a missing summary. |
