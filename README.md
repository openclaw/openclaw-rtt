...
Latest imported release coverage run: `2026-09-23T23:41:53.854Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.5` | - | - | `5,379MB` | `5,379MB` | failed |
| `2026.9.4` | - | - | `5,401MB` | `5,401MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `4,877MB` | `4,877MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,234MB` | `5,234MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `4,983MB` | `4,983MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,346MB` | `5,346MB` | failed: QA command exited with status 1 after producing a missing summary. |
