...
Latest imported channel run: `2026-08-05T07:58:17.499Z` · latest `2026.7.2` / `7617e91d70`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,018ms` | `2,117ms` | `149MB` | `149MB` | ok |
| Discord | `3,360ms` | `3,597ms` | `3,137MB` | `3,160MB` | ok |
| Slack | `4,813ms` | `4,813ms` | `3,197MB` | `3,197MB` | stale: latest failed; showing last pass (failed: QA command exited with status 1 before writing a summary.) |
...
Latest imported release coverage run: `2026-08-05T01:51:50.427Z`
...
| `2026.7.2-beta.3` | - | - | `1,121MB` | `1,121MB` | failed |
| `2026.7.2-beta.2` | - | - | `1,131MB` | `1,131MB` | failed: QA command exited with status 1 before writing a summary. |
...
| `2026.5.16-beta.5` | `4,703ms` | `4,791ms` | `716MB` | `716MB` | failed: QA command exited with status 0 before writing a summary. |
...
| `2026.6.6` | - | - | `646MB` | `646MB` | failed: QA command exited with status 0 before writing a summary. |
| `2026.6.6-beta.2` | - | - | `608MB` | `608MB` | failed: QA command exited with status 0 before writing a summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `604MB` | `604MB` | failed: QA command exited with status 0 before writing a summary. |
