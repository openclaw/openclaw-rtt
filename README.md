...
Latest imported channel run: `2026-07-23T18:55:24.426Z` · latest `2026.7.2` / `13176b446a`
...
Latest imported release coverage run: `2026-07-23T15:53:01.588Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.3` | - | - | `1,171MB` | `1,171MB` | failed |
| `2026.7.2-beta.2` | - | - | `1,215MB` | `1,215MB` | failed |
