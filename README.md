...
Latest imported channel run: `2026-09-19T06:58:59.741Z` · latest `2026.9.4` / `6690ddfab3`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,001ms` | `2,007ms` | `87MB` | `87MB` | ok |
| Discord | `1,952ms` | `2,446ms` | `1,136MB` | `1,223MB` | ok |
| Slack | `3,301ms` | `3,400ms` | `1,033MB` | `1,039MB` | ok |
...
Latest imported surface run: `2026-09-19T06:45:32.454Z` · latest `2026.9.4` / `74b3fa42ce`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `93MB` | `109MB` | ok: gateway RPC |
| Control UI | `152ms` | `412ms` | `524MB` | `1,109MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-19T06:55:22.982Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.9.5` | `65ms` | - | - | fail | fail | `1ms` | `131ms` |
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.5` | - | - | `5,402MB` | `5,402MB` | failed |
| `2026.9.4` | - | - | `5,423MB` | `5,423MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,296MB` | `5,296MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `4,975MB` | `4,975MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,378MB` | `5,378MB` | failed: QA command exited with status 1 after producing a missing summary. |
