...
Latest imported channel run: `2026-08-28T22:00:34.566Z` · latest `2026.8.1` / `15046d3803`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,025ms` | `2,121ms` | `138MB` | `138MB` | ok |
...
Latest imported surface run: `2026-08-28T21:45:28.161Z` · latest `2026.8.1` / `5b605da389`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `2ms` | `180MB` | `196MB` | ok: gateway RPC |
| Control UI | `217ms` | `274ms` | `502MB` | `887MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-08-28T22:38:20.190Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.9.1-beta.1` | - | - | - | fail | fail | - | `334ms` |
...
Latest imported surface run: `2026-08-28T21:50:49.136Z`
...
| `2026.7.1-2` | `1,028ms` | `2,051ms` | `137MB` | `137MB` | ok |
