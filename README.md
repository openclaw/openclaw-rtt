...
Latest imported channel run: `2026-08-07T18:53:30.885Z` · latest `2026.7.2` / `c25671cf27`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,034ms` | `2,031ms` | `140MB` | `140MB` | ok |
| Discord | `3,431ms` | `4,846ms` | `3,126MB` | `3,155MB` | ok |
| Slack | `4,160ms` | `4,160ms` | `3,225MB` | `3,225MB` | ok |
...
Latest imported surface run: `2026-08-09T12:43:28.946Z` · latest `2026.8.1` / `8dad2bf0ce`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `3ms` | `175MB` | `177MB` | ok: gateway RPC |
| Control UI | `190ms` | `338ms` | `501MB` | `954MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-08-24T07:41:25.491Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.8.1-beta.3` | - | - | - | fail | fail | - | - |
| `2026.8.1-beta.2` | - | - | - | fail | fail | - | - |
| `2026.8.1-beta.1` | - | - | - | fail | fail | - | `201ms` |
...
| `2026.7.2-beta.4` | `863ms` | `1,024ms` | `2,149ms` | fail | fail | `0ms` | `113ms` |
...
| `2026.7.1-beta.4` | `1,094ms` | n/a | `1,787ms` | `3,378ms` | fail | `1,796ms` | `284ms` |
...
| `2026.6.9` | `928ms` | `1,974ms` | `2,166ms` | `3,301ms` | fail | `2,176ms` | `403ms` |
| `2026.6.9-beta.1` | `925ms` | `1,970ms` | `2,167ms` | `3,293ms` | fail | `2,175ms` | `405ms` |
| `2026.6.8` | `955ms` | `1,984ms` | `2,340ms` | `3,363ms` | fail | `2,351ms` | `417ms` |
| `2026.6.8-beta.2` | `1,500ms` | `1,927ms` | `2,016ms` | `4,978ms` | fail | `2,016ms` | `354ms` |
...
Latest imported surface run: `2026-08-10T18:54:07.644Z`

| Version | RPC | Control UI |
|---|---:|---:|
| `2026.8.1-beta.1` | - | `201ms` |
| `2026.7.2-beta.7` | - | `109ms` |
| `2026.7.2-beta.6` | `2,996ms` | `106ms` |
...
| `2026.6.9` | `2,176ms` | `403ms` |
| `2026.6.9-beta.1` | `2,175ms` | `405ms` |
| `2026.6.8` | `2,351ms` | `417ms` |
...
| `2026.8.1-beta.1` | - | - | `1,356MB` | `1,356MB` | failed |
| `2026.7.2-beta.7` | - | - | `1,196MB` | `1,196MB` | failed |
...
| `2026.5.18-beta.1` | - | - | `740MB` | `740MB` | failed: QA command exited with status 0 before writing a summary. |
| `2026.5.16-beta.7` | `4,704ms` | `6,118ms` | `699MB` | `762MB` | ok |
| `2026.5.16-beta.6` | `4,719ms` | `5,051ms` | `724MB` | `760MB` | ok |
| `2026.5.16-beta.5` | `4,703ms` | `4,791ms` | `768MB` | `768MB` | failed: QA command exited with status 0 before writing a summary. |
...
| `2026.6.8-beta.2` | - | - | `651MB` | `651MB` | failed |
...
| `2026.6.6-beta.2` | - | - | `651MB` | `651MB` | failed: QA command exited with status 0 before writing a summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `624MB` | `624MB` | failed: QA command exited with status 0 before writing a summary. |
