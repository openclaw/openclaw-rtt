...
Latest imported channel run: `2026-08-06T12:53:20.843Z` · latest `2026.7.2` / `b0c368ae34`
...
Latest imported surface run: `2026-08-06T13:07:06.896Z` · latest `2026.7.2` / `cd009e72f0`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `2ms` | `2ms` | `176MB` | `179MB` | ok: gateway RPC |
| Control UI | `208ms` | `376ms` | `490MB` | `1,168MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-08-06T09:22:47.380Z`
...
| `2026.7.2-beta.2` | - | - | `1,164MB` | `1,164MB` | failed |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `634MB` | `634MB` | failed: QA command exited with status 0 before writing a summary. |
