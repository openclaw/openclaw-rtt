...
Latest imported channel run: `2026-06-24T19:38:02.721Z` · latest `2026.6.10` / `1adc076148`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,914ms` | `2,053ms` | `1,191MB` | `1,231MB` | ok |
| Slack | `4,759ms` | `4,759ms` | `1,051MB` | `1,051MB` | stale: latest failed; showing last pass (failed) |
...
Latest imported surface run: `2026-06-24T19:03:31.443Z` · latest `2026.6.10` / `eac1d3349c`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `7ms` | `14ms` | `176MB` | `183MB` | ok: gateway RPC |
| Control UI | `413ms` | `476ms` | `450MB` | `907MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-24T14:11:10.021Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `779MB` | `786MB` | timeout |
| `2026.5.16-beta.5` | - | - | `778MB` | `785MB` | timeout |
