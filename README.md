...
Latest imported channel run: `2026-07-09T19:25:23.671Z` · latest `2026.6.11` / `266ca5b3a2`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,853ms` | `2,030ms` | `1,054MB` | `1,057MB` | ok |
| Slack | `8,148ms` | `8,148ms` | `980MB` | `980MB` | stale: latest failed; showing last pass (failed) |
...
Latest imported surface run: `2026-07-09T19:03:44.210Z` · latest `2026.6.11` / `8656c3b357`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `4ms` | `8ms` | `175MB` | `183MB` | ok: gateway RPC |
| Control UI | `292ms` | `344ms` | `459MB` | `912MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-09T14:30:47.620Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `958MB` | `992MB` | timeout |
| `2026.5.16-beta.5` | - | - | `956MB` | `989MB` | timeout |
...
| `2026.6.8-beta.1` | - | - | `627MB` | `627MB` | failed |
| `2026.6.7-beta.1` | - | - | `622MB` | `622MB` | failed |
| `2026.6.6` | - | - | `618MB` | `618MB` | failed: QA command exited with status 0 before writing a summary. |
