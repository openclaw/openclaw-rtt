...
Latest imported channel run: `2026-07-10T19:24:14.266Z` · latest `2026.6.11` / `fece8c9f54`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,897ms` | `2,522ms` | `1,184MB` | `1,204MB` | ok |
| Slack | `4,822ms` | `4,822ms` | `945MB` | `945MB` | ok |
...
Latest imported surface run: `2026-07-10T18:58:46.610Z` · latest `2026.6.11` / `5a48e73973`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `5ms` | `9ms` | `175MB` | `183MB` | ok: gateway RPC |
| Control UI | `303ms` | `328ms` | `457MB` | `976MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-10T14:07:40.203Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `1,020MB` | `1,023MB` | timeout |
| `2026.5.16-beta.5` | - | - | `1,018MB` | `1,045MB` | timeout |
...
| `2026.6.8-beta.1` | - | - | `626MB` | `626MB` | failed |
| `2026.6.7-beta.1` | - | - | `618MB` | `618MB` | failed |
| `2026.6.6` | - | - | `623MB` | `623MB` | failed: QA command exited with status 0 before writing a summary. |
| `2026.6.6-beta.2` | - | - | `625MB` | `625MB` | failed: QA command exited with status 0 before writing a summary. |
