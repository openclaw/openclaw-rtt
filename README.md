...
Latest imported channel run: `2026-06-09T01:03:55.940Z` · latest `2026.6.2` / `80f1ae6ffe`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,004ms` | `8,450ms` | `137MB` | `137MB` | ok |
| Discord | `2,076ms` | `2,306ms` | `1,048MB` | `1,141MB` | ok |
| Slack | `3,124ms` | `3,380ms` | `1,010MB` | `1,030MB` | ok |
| WhatsApp | `3,230ms` | `3,957ms` | `1,056MB` | `1,083MB` | ok |
...
Latest imported surface run: `2026-06-09T01:23:02.390Z` · latest `2026.6.2` / `c4a0ca0b7a`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `5ms` | `9ms` | `174MB` | `182MB` | ok: gateway RPC |
| Control UI | `403ms` | `412ms` | `447MB` | `1,092MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-09T01:18:17.462Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.6.5-beta.5` | - | `1,145ms` | - | - | - | - | - |
| `2026.6.5-beta.3` | - | `1,013ms` | - | - | - | - | - |
