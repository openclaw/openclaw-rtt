...
Latest imported channel run: `2026-06-22T20:10:58.287Z` · latest `2026.6.9` / `2dc2d73b07`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,776ms` | `2,022ms` | `1,171MB` | `1,193MB` | ok |
| Slack | `3,299ms` | `3,299ms` | `1,054MB` | `1,054MB` | ok |
...
Latest imported surface run: `2026-06-23T01:22:10.006Z` · latest `2026.6.9` / `9fa14ff61a`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `6ms` | `14ms` | `175MB` | `184MB` | ok: gateway RPC |
| Control UI | `405ms` | `425ms` | `450MB` | `922MB` | ok: browser/Gateway |
...
Latest imported surface run: `2026-06-22T16:21:31.140Z`
...
| `2026.6.7-beta.1` | - | - | `609MB` | `609MB` | failed |
