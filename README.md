...
Latest imported channel run: `2026-09-15T06:58:51.028Z` · latest `2026.9.4` / `938877bdb5`
...
Latest imported release coverage run: `2026-09-15T05:25:15.631Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,451MB` | `5,451MB` | failed |
| `2026.9.3` | - | - | `5,427MB` | `5,427MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,138MB` | `5,138MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,228MB` | `5,228MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,257MB` | `5,257MB` | failed: QA command exited with status 1 after producing a missing summary. |
