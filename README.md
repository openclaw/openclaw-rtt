...
Latest imported channel run: `2026-07-24T01:21:25.062Z` · latest `2026.7.2` / `bb657eec93`
...
Latest imported release coverage run: `2026-07-24T07:25:25.200Z`
...
Latest imported surface run: `2026-07-24T07:25:25.200Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.3` | - | - | `1,113MB` | `1,113MB` | failed |
| `2026.7.2-beta.2` | - | - | `1,077MB` | `1,077MB` | failed |
...
| `2026.6.9-beta.1` | - | - | `630MB` | `630MB` | failed |
