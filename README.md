...
Latest imported channel run: `2026-08-24T15:41:49.523Z` · latest `2026.8.1` / `a23e77b61a`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,034ms` | `2,031ms` | `140MB` | `140MB` | ok |
| Discord | `3,431ms` | `4,846ms` | `3,126MB` | `3,155MB` | stale: latest failed; showing last pass (failed) |
| Slack | `4,160ms` | `4,160ms` | `3,225MB` | `3,225MB` | stale: latest failed; showing last pass (failed) |
...
Latest imported surface run: `2026-08-24T18:45:49.672Z` · latest `2026.8.1` / `bf83a4dde8`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `2ms` | `10ms` | `179MB` | `188MB` | ok: gateway RPC |
| Control UI | `237ms` | `399ms` | `496MB` | `925MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-08-24T18:54:28.560Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.8.1-beta.3` | - | - | - | fail | fail | - | `222ms` |
| `2026.8.1-beta.2` | - | - | - | fail | fail | - | `194ms` |
...
Latest imported surface run: `2026-08-24T18:54:28.560Z`
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `702MB` | `702MB` | failed: QA command exited with status 0 before writing a summary. |
