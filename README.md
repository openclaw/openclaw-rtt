...
Latest imported channel run: `2026-07-29T07:48:51.030Z` · latest `2026.7.2` / `c392268a05`
...
Latest imported surface run: `2026-07-29T07:26:06.595Z` · latest `2026.7.2` / `dd3d1d1a8b`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `6ms` | `7ms` | `189MB` | `191MB` | ok: gateway RPC |
| Control UI | `131ms` | `165ms` | `502MB` | `1,173MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-29T03:00:01.441Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.5` | - | - | `1,185MB` | `1,185MB` | failed |
| `2026.7.2-beta.4` | - | - | `1,135MB` | `1,135MB` | failed |
| `2026.7.2-beta.3` | - | - | `1,092MB` | `1,092MB` | failed |
| `2026.7.2-beta.2` | - | - | `1,080MB` | `1,080MB` | failed |
...
| `2026.6.9` | - | - | `634MB` | `634MB` | failed |
| `2026.6.9-beta.1` | - | - | `670MB` | `670MB` | failed |
| `2026.6.8` | - | - | `665MB` | `665MB` | failed |
| `2026.6.8-beta.2` | - | - | `666MB` | `666MB` | failed |
