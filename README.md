...
Latest imported release coverage run: `2026-09-26T05:48:26.946Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.6` | - | - | `5,552MB` | `5,552MB` | failed |
| `2026.9.5` | - | - | `5,284MB` | `5,284MB` | failed |
| `2026.9.4` | - | - | `5,483MB` | `5,483MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.9.3` | - | - | `5,387MB` | `5,387MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,397MB` | `5,397MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,315MB` | `5,315MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,336MB` | `5,336MB` | failed: QA command exited with status 1 after producing a missing summary. |
