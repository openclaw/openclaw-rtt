...
Latest imported channel run: `2026-07-01T01:49:19.201Z` · latest `2026.6.11` / `7ceaf0ece3`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,911ms` | `2,411ms` | `1,167MB` | `1,215MB` | ok |
| Slack | `3,613ms` | `3,613ms` | `1,049MB` | `1,049MB` | stale: latest failed; showing last pass (failed) |
...
Latest imported surface run: `2026-07-01T01:30:19.595Z` · latest `2026.6.11` / `35af831fd0`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `5ms` | `8ms` | `175MB` | `184MB` | ok: gateway RPC |
| Control UI | `412ms` | `429ms` | `450MB` | `942MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-30T20:25:35.918Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `771MB` | `792MB` | timeout |
| `2026.5.16-beta.5` | - | - | `784MB` | `803MB` | timeout |
