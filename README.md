...
Latest imported channel run: `2026-09-03T16:48:51.459Z` · latest `2026.8.1` / `428fa8e0d3`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,000ms` | `2,008ms` | `86MB` | `86MB` | ok |
...
Latest imported release coverage run: `2026-09-03T17:49:23.959Z`
...
| `2026.6.34` | `1,033ms` | `1,000ms` | `1,770ms` | `2,905ms` | fail | `7ms` | `400ms` |
...
| `2026.6.34` | `2,905ms` | `2,905ms` | `5,250MB` | `5,250MB` | ok |
