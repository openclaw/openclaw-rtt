...
Latest imported channel run: `2026-09-19T12:49:50.758Z` · latest `2026.9.5` / `c30f2063c2`
...
Latest imported release coverage run: `2026-09-19T11:14:41.856Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.5` | - | - | `5,482MB` | `5,482MB` | failed |
| `2026.9.4` | - | - | `5,442MB` | `5,442MB` | failed |
| `2026.9.3` | - | - | `5,382MB` | `5,382MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,429MB` | `5,429MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.6.6-beta.2` | - | - | `5,336MB` | `5,336MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,365MB` | `5,365MB` | failed: QA command exited with status 1 after producing a missing summary. |
