...
Latest imported release coverage run: `2026-07-24T09:22:28.661Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.4` | - | - | `1,150MB` | `1,150MB` | failed |
| `2026.7.2-beta.3` | - | - | `1,302MB` | `1,302MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `634MB` | `634MB` | failed |
