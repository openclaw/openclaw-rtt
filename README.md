...
Latest imported channel run: `2026-06-02T08:22:39.053Z` · latest `2026.6.2` / `e31f351923`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,015ms` | `14,729ms` | `136MB` | `136MB` | ok |
| Discord | `2,052ms` | `2,370ms` | `968MB` | `1,161MB` | ok |
...
| WhatsApp | `3,283ms` | `3,779ms` | `1,002MB` | `1,036MB` | ok |
