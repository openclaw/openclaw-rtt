...
Latest imported channel run: `2026-06-26T19:39:15.209Z` · latest `2026.6.10` / `1089253ca9`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,759ms` | `1,917ms` | `1,207MB` | `1,239MB` | ok |
| Slack | `3,282ms` | `3,282ms` | `1,058MB` | `1,058MB` | stale: latest failed; showing last pass (failed) |
...
Latest imported surface run: `2026-06-26T19:05:34.568Z` · latest `2026.6.10` / `e5123e44b0`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `8ms` | `13ms` | `175MB` | `188MB` | ok: gateway RPC |
| Control UI | `326ms` | `455ms` | `451MB` | `920MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-26T20:06:01.540Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `779MB` | `794MB` | timeout |
| `2026.5.16-beta.5` | - | - | `779MB` | `786MB` | timeout |
...
| `2026.6.8-beta.1` | - | - | `612MB` | `612MB` | failed |
