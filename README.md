...
Latest imported channel run: `2026-09-02T13:26:10.046Z` · latest `2026.8.1` / `abb565ea5f`
...
| Slack | `4,160ms` | `4,160ms` | `3,225MB` | `3,225MB` | stale: latest failed; showing last pass (failed: QA command exited with status 1 before writing a summary.) |
...
Latest imported surface run: `2026-09-02T18:39:04.613Z` · latest `2026.8.1` / `af531525c4`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `2ms` | `91MB` | `109MB` | ok: gateway RPC |
| Control UI | `166ms` | `360ms` | `503MB` | `1,029MB` | ok: browser/Gateway |
...
Latest imported surface run: `2026-09-02T06:57:33.069Z`
