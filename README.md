...
Latest imported channel run: `2026-09-24T14:13:23.866Z` · latest `2026.9.6` / `34757eb298`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,001ms` | `2,007ms` | `87MB` | `87MB` | ok |
| Discord | `3,899ms` | `4,108ms` | `1,252MB` | `1,295MB` | ok |
| Slack | `4,123ms` | `5,428ms` | `1,170MB` | `1,216MB` | ok |
...
Latest imported surface run: `2026-09-24T12:48:24.569Z` · latest `2026.9.6` / `4d69dd0200`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `5ms` | `93MB` | `112MB` | ok: gateway RPC |
| Control UI | `279ms` | `389ms` | `522MB` | `1,007MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-24T11:59:26.161Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.6` | - | - | `5,417MB` | `5,417MB` | failed |
| `2026.9.5` | - | - | `5,289MB` | `5,289MB` | failed |
| `2026.9.4` | - | - | `5,263MB` | `5,263MB` | failed |
| `2026.9.3` | - | - | `5,313MB` | `5,313MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,395MB` | `5,395MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.6.6-beta.2` | - | - | `5,398MB` | `5,398MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,344MB` | `5,344MB` | failed: QA command exited with status 1 after producing a missing summary. |
