...
Latest imported surface run: `2026-08-08T12:44:31.640Z` · latest `2026.8.1` / `e5d4fe02a4`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `3ms` | `176MB` | `178MB` | ok: gateway RPC |
| Control UI | `186ms` | `201ms` | `495MB` | `1,165MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-08-08T08:41:20.727Z`
...
| `2026.7.2-beta.3` | - | - | `1,199MB` | `1,199MB` | failed |
...
| `2026.5.16-beta.5` | `4,703ms` | `4,791ms` | `711MB` | `711MB` | failed: QA command exited with status 0 before writing a summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `616MB` | `616MB` | failed: QA command exited with status 0 before writing a summary. |
