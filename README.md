...
Latest imported channel run: `2026-07-04T01:07:10.540Z` · latest `2026.6.11` / `ccd960ac4a`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,606ms` | `2,098ms` | `1,218MB` | `1,250MB` | ok |
| Slack | `3,345ms` | `3,345ms` | `1,049MB` | `1,049MB` | ok |
...
Latest imported surface run: `2026-07-04T01:04:19.047Z` · latest `2026.6.11` / `336b14978b`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `4ms` | `8ms` | `175MB` | `185MB` | ok: gateway RPC |
| Control UI | `406ms` | `417ms` | `448MB` | `934MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-03T19:47:26.360Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `799MB` | `809MB` | timeout |
| `2026.5.16-beta.5` | - | - | `802MB` | `834MB` | timeout |
...
| `2026.6.8-beta.1` | - | - | `640MB` | `640MB` | failed |
