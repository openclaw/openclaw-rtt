...
Latest imported surface run: `2026-09-23T18:40:53.912Z` · latest `2026.9.5` / `ae53b4f777`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `2ms` | `3ms` | `94MB` | `114MB` | ok: gateway RPC |
| Control UI | `279ms` | `369ms` | `525MB` | `972MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-23T17:47:15.602Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.5` | - | - | `5,394MB` | `5,394MB` | failed |
| `2026.9.4` | - | - | `5,230MB` | `5,230MB` | failed |
| `2026.9.3` | - | - | `5,052MB` | `5,052MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `4,892MB` | `4,892MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,379MB` | `5,379MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,260MB` | `5,260MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `4,930MB` | `4,930MB` | failed: QA command exited with status 1 after producing a missing summary. |
