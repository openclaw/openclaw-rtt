...
Latest imported release coverage run: `2026-09-16T17:33:46.152Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,017MB` | `5,017MB` | failed |
| `2026.9.3` | - | - | `5,426MB` | `5,426MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,200MB` | `5,200MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,385MB` | `5,385MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,026MB` | `5,026MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,042MB` | `5,042MB` | failed: QA command exited with status 1 after producing a missing summary. |
