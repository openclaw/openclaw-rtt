...
Latest imported channel run: `2026-09-01T13:07:09.908Z` · latest `2026.8.1` / `f61666a6fa`
...
Latest imported surface run: `2026-09-01T18:41:01.172Z` · latest `2026.8.1` / `9030d86e7b`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `2ms` | `7ms` | `91MB` | `109MB` | ok: gateway RPC |
| Control UI | `228ms` | `406ms` | `509MB` | `882MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-01T12:45:22.517Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.9.1-beta.1` | `333ms` | `999ms` | - | fail | fail | - | `334ms` |
| `2026.8.1` | - | `1,001ms` | - | fail | fail | - | - |
