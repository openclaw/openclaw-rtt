...
Latest imported channel run: `2026-09-07T18:46:12.223Z` · latest `2026.9.2` / `6fc78e7a81`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `999ms` | `2,004ms` | `86MB` | `86MB` | ok |
| Discord | `1,314ms` | `1,412ms` | `727MB` | `731MB` | ok |
| Slack | `1,617ms` | `2,904ms` | `657MB` | `672MB` | ok |
...
Latest imported surface run: `2026-09-07T18:37:10.204Z` · latest `2026.9.2` / `6fc78e7a81`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `93MB` | `111MB` | ok: gateway RPC |
| Control UI | `144ms` | `273ms` | `517MB` | `1,034MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-07T16:33:05.977Z`
...
| `2026.6.8-beta.2` | - | - | `5,355MB` | `5,355MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `4,929MB` | `4,929MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,352MB` | `5,352MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,342MB` | `5,342MB` | failed: QA command exited with status 1 after producing a missing summary. |
