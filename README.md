...
Latest imported channel run: `2026-09-13T13:06:40.006Z` · latest `2026.9.4` / `818a9c7be0`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,003ms` | `2,002ms` | `87MB` | `87MB` | ok |
| Discord | `2,191ms` | `2,407ms` | `964MB` | `973MB` | ok |
| Slack | `3,308ms` | `3,834ms` | `822MB` | `828MB` | ok |
...
Latest imported release coverage run: `2026-09-13T16:58:45.840Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,319MB` | `5,319MB` | failed |
| `2026.9.3` | - | - | `5,483MB` | `5,483MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,299MB` | `5,299MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,450MB` | `5,450MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,331MB` | `5,331MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,366MB` | `5,366MB` | failed: QA command exited with status 1 after producing a missing summary. |
