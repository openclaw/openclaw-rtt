...
Latest imported channel run: `2026-06-04T01:18:00.141Z` · latest `2026.6.2` / `4cb34f3999`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,001ms` | `2,275ms` | `137MB` | `137MB` | ok |
| Discord | `1,940ms` | `2,349ms` | `979MB` | `1,179MB` | ok |
| Slack | `2,912ms` | `4,212ms` | `965MB` | `995MB` | ok |
| WhatsApp | `3,171ms` | `4,079ms` | `1,005MB` | `1,029MB` | ok |
...
Latest imported surface run: `2026-06-03T19:44:34.612Z` · latest `2026.6.2` / `f0237caf27`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `5ms` | `8ms` | `173MB` | `183MB` | ok: gateway RPC |
| Control UI | `313ms` | `329ms` | `444MB` | `1,101MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-03T20:28:53.471Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.6.1` | `1,156ms` | - | `1,862ms` | `3,190ms` | `3,303ms` | `3,147ms` | `303ms` |
...
Latest imported surface run: `2026-06-03T20:07:58.625Z`
...
|---|---:|---:|---:|---:|---|
| `2026.6.1` | - | - | - | - | missing: no imported run |
