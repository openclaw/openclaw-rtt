...
Latest imported channel run: `2026-07-01T19:38:27.893Z` · latest `2026.6.11` / `ab2f6f5642`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,850ms` | `2,122ms` | `1,200MB` | `1,252MB` | ok |
| Slack | `4,617ms` | `4,617ms` | `1,071MB` | `1,071MB` | stale: latest failed; showing last pass (failed) |
...
Latest imported surface run: `2026-07-01T19:09:31.373Z` · latest `2026.6.11` / `24d94a54a5`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `5ms` | `10ms` | `183MB` | `184MB` | ok: gateway RPC |
| Control UI | `406ms` | `479ms` | `451MB` | `923MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-01T14:17:08.401Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `789MB` | `822MB` | timeout |
| `2026.5.16-beta.5` | - | - | `784MB` | `812MB` | timeout |
...
| `2026.6.7-beta.1` | - | - | `611MB` | `611MB` | failed |
