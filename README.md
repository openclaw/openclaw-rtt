...
Latest imported channel run: `2026-09-15T07:24:01.152Z` · latest `2026.9.4` / `d02f206fb1`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,003ms` | `2,002ms` | `87MB` | `87MB` | ok |
| Discord | `1,957ms` | `2,174ms` | `1,030MB` | `1,037MB` | ok |
| Slack | `2,887ms` | `3,000ms` | `932MB` | `1,043MB` | ok |
...
Latest imported surface run: `2026-09-15T06:50:00.013Z` · latest `2026.9.4` / `938877bdb5`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `90MB` | `113MB` | ok: gateway RPC |
| Control UI | `215ms` | `377ms` | `518MB` | `1,056MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-15T11:57:08.478Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,400MB` | `5,400MB` | failed |
| `2026.9.3` | - | - | `5,250MB` | `5,250MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `4,898MB` | `4,898MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,023MB` | `5,023MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,002MB` | `5,002MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,394MB` | `5,394MB` | failed: QA command exited with status 1 after producing a missing summary. |
