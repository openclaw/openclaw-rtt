...
Latest imported channel run: `2026-09-15T01:36:43.086Z` · latest `2026.9.4` / `55e261df56`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,003ms` | `2,002ms` | `87MB` | `87MB` | ok |
| Discord | `2,230ms` | `2,428ms` | `1,015MB` | `1,028MB` | ok |
| Slack | `3,305ms` | `3,363ms` | `928MB` | `1,032MB` | ok |
...
Latest imported surface run: `2026-09-15T01:09:18.205Z` · latest `2026.9.4` / `9b9814bf8c`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `2ms` | `92MB` | `114MB` | ok: gateway RPC |
| Control UI | `325ms` | `507ms` | `515MB` | `1,010MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-14T23:33:56.405Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `4,988MB` | `4,988MB` | failed |
| `2026.9.3` | - | - | `4,994MB` | `4,994MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `4,999MB` | `4,999MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `4,895MB` | `4,895MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,068MB` | `5,068MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,243MB` | `5,243MB` | failed: QA command exited with status 1 after producing a missing summary. |
