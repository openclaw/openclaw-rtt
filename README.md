...
Latest imported release coverage run: `2026-07-05T19:51:53.958Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.1-beta.2` | - | - | `652MB` | `652MB` | failed |
...
| `2026.6.7-beta.1` | - | - | `597MB` | `597MB` | failed |
| `2026.6.6` | - | - | `592MB` | `592MB` | failed: QA command exited with status 0 before writing a summary. |
