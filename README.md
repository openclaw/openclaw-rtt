...
Latest imported channel run: `2026-07-23T13:03:12.060Z` · latest `2026.7.2` / `245795ce64`
...
Latest imported surface run: `2026-07-23T13:00:01.815Z` · latest `2026.7.2` / `245795ce64`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `9ms` | `12ms` | `163MB` | `168MB` | ok: gateway RPC |
| Control UI | `130ms` | `355ms` | `492MB` | `956MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-23T09:08:58.254Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.7.2-beta.3` | - | - | `1,117MB` | `1,117MB` | failed |
| `2026.7.2-beta.2` | - | - | `1,064MB` | `1,064MB` | failed |
...
| `2026.6.9-beta.1` | - | - | `656MB` | `656MB` | failed |
| `2026.6.8` | - | - | `666MB` | `666MB` | failed |
| `2026.6.8-beta.2` | - | - | `636MB` | `636MB` | failed |
