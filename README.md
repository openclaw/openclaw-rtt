...
Latest imported surface run: `2026-07-30T18:58:54.538Z` · latest `2026.7.2` / `b907309b35`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `2ms` | `187MB` | `190MB` | ok: gateway RPC |
| Control UI | `347ms` | `411ms` | `479MB` | `1,173MB` | ok: browser/Gateway |
