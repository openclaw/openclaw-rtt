...
Latest imported release coverage run: `2026-09-26T11:35:57.987Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.6` | - | - | `5,286MB` | `5,286MB` | failed |
| `2026.9.5` | - | - | `5,393MB` | `5,393MB` | failed |
| `2026.9.4` | - | - | `5,398MB` | `5,398MB` | failed |
| `2026.9.3` | - | - | `5,465MB` | `5,465MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,319MB` | `5,319MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,458MB` | `5,458MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,264MB` | `5,264MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,459MB` | `5,459MB` | failed: QA command exited with status 1 after producing a missing summary. |
