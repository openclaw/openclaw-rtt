...
Latest imported channel run: `2026-07-20T19:24:50.447Z` · latest `2026.7.2` / `e2bb04328f`
...
Latest imported surface run: `2026-07-20T19:08:48.010Z` · latest `2026.7.2` / `cadad3b7bd`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `8ms` | `63ms` | `162MB` | `167MB` | ok: gateway RPC |
| Control UI | `126ms` | `334ms` | `483MB` | `1,004MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-20T15:18:44.094Z`
...
| `2026.7.2-beta.2` | - | - | `1,222MB` | `1,222MB` | failed |
...
| `2026.6.8-beta.1` | - | - | `664MB` | `664MB` | failed |
| `2026.6.7-beta.1` | - | - | `663MB` | `663MB` | failed |
| `2026.6.6` | - | - | `635MB` | `635MB` | failed: QA command exited with status 0 before writing a summary. |
| `2026.6.6-beta.2` | - | - | `612MB` | `612MB` | failed: QA command exited with status 0 before writing a summary. |
