...
Latest imported channel run: `2026-09-11T01:34:02.661Z` · latest `2026.9.3` / `8947c21335`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,000ms` | `2,007ms` | `86MB` | `86MB` | ok |
| Discord | `2,311ms` | `2,436ms` | `709MB` | `778MB` | ok |
| Slack | `3,316ms` | `3,527ms` | `699MB` | `712MB` | ok |
...
Latest imported surface run: `2026-09-11T01:05:03.465Z` · latest `2026.9.3` / `d841e35101`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `93MB` | `112MB` | ok: gateway RPC |
| Control UI | `254ms` | `393ms` | `512MB` | `1,010MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-11T03:51:40.069Z`

| Version | p50 σ | Telegram | Discord | Slack | WhatsApp | RPC | Control UI |
|---|---:|---:|---:|---:|---:|---:|---:|
| `2026.9.4` | n/a | - | - | fail | fail | - | - |
...
Latest imported surface run: `2026-09-08T18:51:14.048Z`
...
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | - | - | missing: no imported run |
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,425MB` | `5,425MB` | failed |
| `2026.9.3` | - | - | `5,491MB` | `5,491MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,326MB` | `5,326MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,111MB` | `5,111MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,215MB` | `5,215MB` | failed: QA command exited with status 1 after producing a missing summary. |
