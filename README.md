...
Latest imported channel run: `2026-07-08T19:22:45.556Z` · latest `2026.6.11` / `b81666ca6a`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,939ms` | `2,172ms` | `1,048MB` | `1,165MB` | ok |
| Slack | `2,983ms` | `2,983ms` | `869MB` | `869MB` | stale: latest failed; showing last pass (failed) |
...
Latest imported surface run: `2026-07-08T18:56:53.521Z` · latest `2026.6.11` / `b81666ca6a`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `6ms` | `10ms` | `182MB` | `188MB` | ok: gateway RPC |
| Control UI | `300ms` | `340ms` | `455MB` | `940MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-08T13:59:38.049Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `896MB` | `909MB` | timeout |
| `2026.5.16-beta.5` | - | - | `903MB` | `959MB` | timeout |
...
| `2026.6.7-beta.1` | - | - | `623MB` | `623MB` | failed |
| `2026.6.6` | - | - | `615MB` | `615MB` | failed: QA command exited with status 0 before writing a summary. |
| `2026.6.6-beta.2` | - | - | `617MB` | `617MB` | failed: QA command exited with status 0 before writing a summary. |
