...
Latest imported channel run: `2026-09-18T13:23:46.145Z` · latest `2026.9.4` / `e14de8fe61`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,001ms` | `2,007ms` | `87MB` | `87MB` | ok |
| Discord | `1,644ms` | `2,003ms` | `1,031MB` | `1,039MB` | ok |
| Slack | `2,935ms` | `3,703ms` | `1,004MB` | `1,102MB` | ok |
...
Latest imported surface run: `2026-09-18T12:44:31.069Z` · latest `2026.9.4` / `aea5ed78bc`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `93MB` | `110MB` | ok: gateway RPC |
| Control UI | `211ms` | `312ms` | `527MB` | `1,077MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-18T09:35:39.601Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.4` | - | - | `5,513MB` | `5,513MB` | failed |
| `2026.9.3` | - | - | `5,326MB` | `5,326MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.6.8-beta.2` | - | - | `5,280MB` | `5,280MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,396MB` | `5,396MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `5,281MB` | `5,281MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,391MB` | `5,391MB` | failed: QA command exited with status 1 after producing a missing summary. |
