...
Latest imported channel run: `2026-09-05T07:06:57.436Z` · latest `2026.9.1` / `1e5b3efc0e`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,001ms` | `2,010ms` | `87MB` | `87MB` | ok |
| Discord | `1,466ms` | `2,172ms` | `750MB` | `760MB` | ok |
| Slack | `2,007ms` | `3,399ms` | `680MB` | `699MB` | ok |
...
Latest imported surface run: `2026-09-05T06:42:37.448Z` · latest `2026.9.1` / `bfbf880320`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `93MB` | `113MB` | ok: gateway RPC |
| Control UI | `124ms` | `177ms` | `509MB` | `1,004MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-05T04:25:27.142Z`
...
| `2026.6.6` | - | - | `5,424MB` | `5,424MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,408MB` | `5,408MB` | failed: QA command exited with status 1 after producing a missing summary. |
