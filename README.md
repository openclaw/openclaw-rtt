...
Latest imported channel run: `2026-09-07T07:19:46.436Z` · latest `2026.9.2` / `00fd5d6a40`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,001ms` | `2,003ms` | `87MB` | `87MB` | ok |
| Discord | `1,551ms` | `1,964ms` | `733MB` | `735MB` | ok |
| Slack | `1,661ms` | `2,918ms` | `665MB` | `681MB` | ok |
...
Latest imported surface run: `2026-09-07T06:58:47.724Z` · latest `2026.9.2` / `a9676bd2b9`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `1ms` | `92MB` | `112MB` | ok: gateway RPC |
| Control UI | `155ms` | `249ms` | `510MB` | `1,018MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-07T10:54:55.522Z`
...
| `2026.6.8-beta.2` | - | - | `5,161MB` | `5,161MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.8-beta.1` | `3,344ms` | `3,344ms` | `1,096MB` | `1,096MB` | ok |
| `2026.6.7-beta.1` | `3,326ms` | `3,326ms` | `1,098MB` | `1,098MB` | ok |
| `2026.6.6` | - | - | `5,218MB` | `5,218MB` | failed: QA command exited with status 1 after producing a missing summary. |
| `2026.6.6-beta.2` | - | - | `4,890MB` | `4,890MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,049MB` | `5,049MB` | failed: QA command exited with status 1 after producing a missing summary. |
