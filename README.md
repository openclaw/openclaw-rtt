...
Latest imported channel run: `2026-06-25T19:44:03.745Z` · latest `2026.6.10` / `1aa7cafc35`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,791ms` | `1,967ms` | `1,194MB` | `1,232MB` | ok |
| Slack | `3,277ms` | `3,277ms` | `1,057MB` | `1,057MB` | stale: latest failed; showing last pass (failed) |
...
Latest imported surface run: `2026-06-25T19:11:20.210Z` · latest `2026.6.10` / `1aa7cafc35`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `8ms` | `12ms` | `175MB` | `184MB` | ok: gateway RPC |
| Control UI | `337ms` | `434ms` | `449MB` | `900MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-06-25T14:05:14.441Z`
...
Latest imported surface run: `2026-06-25T02:14:57.829Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `781MB` | `792MB` | timeout |
| `2026.5.16-beta.5` | - | - | `779MB` | `801MB` | timeout |
...
| `2026.6.8-beta.1` | - | - | `628MB` | `628MB` | failed |
| `2026.6.7-beta.1` | - | - | `610MB` | `610MB` | failed |
| `2026.6.6` | - | - | `622MB` | `622MB` | failed: QA command exited with status 0 before writing a summary. |
| `2026.6.6-beta.2` | - | - | `621MB` | `621MB` | failed: QA command exited with status 0 before writing a summary. |
