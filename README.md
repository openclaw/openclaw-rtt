...
Latest imported channel run: `2026-09-09T01:30:41.081Z` · latest `2026.9.3` / `03497256f9`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,000ms` | `2,004ms` | `87MB` | `87MB` | ok |
| Discord | `1,854ms` | `2,411ms` | `674MB` | `712MB` | ok |
| Slack | `3,342ms` | `3,711ms` | `673MB` | `680MB` | ok |
...
Latest imported surface run: `2026-09-09T01:06:12.750Z` · latest `2026.9.3` / `d721a15258`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `1ms` | `2ms` | `93MB` | `112MB` | ok: gateway RPC |
| Control UI | `188ms` | `395ms` | `507MB` | `1,039MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-09-09T04:53:07.695Z`
...
| npm version | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| `2026.9.3` | - | - | `5,480MB` | `5,480MB` | failed |
...
| `2026.6.8-beta.2` | - | - | `5,517MB` | `5,517MB` | failed: QA command exited with status 1 after producing a missing summary. |
...
| `2026.5.16-beta.7` | `7,607ms` | `9,241ms` | `5,413MB` | `5,413MB` | failed: QA command exited with status 1 after producing a missing summary. |
