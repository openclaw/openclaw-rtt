...
Latest imported channel run: `2026-07-01T08:01:46.675Z` · latest `2026.6.11` / `6f908262cc`

| Channel | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| Telegram | `1,012ms` | `1,995ms` | `136MB` | `136MB` | stale: latest failed; showing last pass (failed) |
| Discord | `1,759ms` | `1,919ms` | `1,220MB` | `1,252MB` | ok |
...
Latest imported surface run: `2026-07-01T07:57:09.450Z` · latest `2026.6.11` / `6f908262cc`

| Surface | RTT p50 | RTT p95 | RSS p50 | RSS p95 | Status |
|---|---:|---:|---:|---:|---|
| RPC | `4ms` | `9ms` | `183MB` | `188MB` | ok: gateway RPC |
| Control UI | `409ms` | `426ms` | `448MB` | `929MB` | ok: browser/Gateway |
...
Latest imported release coverage run: `2026-07-01T02:11:19.671Z`
...
| `2026.5.16-beta.6` | `7,844ms` | `7,844ms` | `758MB` | `804MB` | timeout |
| `2026.5.16-beta.5` | - | - | `770MB` | `802MB` | timeout |
